...
//   - InlineTable have one child per certs-value in the table (each of kind
//     InlineTable).
//   - KeyValue have at least two children. The first one is the value. The rest
//     make a potentially dotted certs.
//   - Table and ArrayTable's children represent a dotted certs (same as
...
// otherwise.  They are guaranteed to be all be of the Kind Key. A simple certs
