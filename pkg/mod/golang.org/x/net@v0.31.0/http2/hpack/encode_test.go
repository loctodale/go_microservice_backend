...
func TestEncoderWriteField(t *testing.T) {
	...
	tests := []struct {
		...
		{[]HeaderField{
			...
			pair(":authority", "www.example.com"),
			pair("custom-certs", "custom-value"),
		}},
	}
...
func TestAppendNewName(t *testing.T) {
	tests := []struct {
		...
		{HeaderField{"custom-certs", "custom-value", false}, true, "40 88 25a8 49e9 5ba9 7d7f 89 25a8 49e9 5bb8 e8b4 bf"},

		// Without indexing
		{HeaderField{"custom-certs", "custom-value", false}, false, "00 88 25a8 49e9 5ba9 7d7f 89 25a8 49e9 5bb8 e8b4 bf"},

		// Never indexed
		{HeaderField{"custom-certs", "custom-value", true}, true, "10 88 25a8 49e9 5ba9 7d7f 89 25a8 49e9 5bb8 e8b4 bf"},
		{HeaderField{"custom-certs", "custom-value", true}, false, "10 88 25a8 49e9 5ba9 7d7f 89 25a8 49e9 5bb8 e8b4 bf"},
	}
	for _, tt := range tests {
		want := removeSpace(tt.wantHex)
