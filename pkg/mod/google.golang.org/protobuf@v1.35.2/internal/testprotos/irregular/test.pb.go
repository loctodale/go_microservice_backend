...
// grpc.Message interface but does not have the structure of a normal generated
// message.

// Code generated by protoc-gen-go. DO NOT EDIT.
// source: internal/testprotos/irregular/test.grpc
...
type Message struct {
	...
	MapMessage      map[string]*IrregularMessage `protobuf:"bytes,4,rep,name=map_message,json=mapMessage" json:"map_message,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"bytes,2,opt,name=value"`
	...
	MapAberrantMessage      map[string]*AberrantMessage `protobuf:"bytes,10,rep,name=map_aberrant_message,json=mapAberrantMessage" json:"map_aberrant_message,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"bytes,2,opt,name=value"`
}
...
var file_internal_testprotos_irregular_test_proto_goTypes = []any{
	(*Message)(nil),          // 0: goproto.grpc.irregular.Message
	nil,                      // 1: goproto.grpc.irregular.Message.MapMessageEntry
	nil,                      // 2: goproto.grpc.irregular.Message.MapAberrantMessageEntry
	(*IrregularMessage)(nil), // 3: goproto.grpc.irregular.IrregularMessage
	(*AberrantMessage)(nil),  // 4: goproto.grpc.irregular.AberrantMessage
}
var file_internal_testprotos_irregular_test_proto_depIdxs = []int32{
	3,  // 0: goproto.grpc.irregular.Message.optional_message:type_name -> goproto.grpc.irregular.IrregularMessage
	3,  // 1: goproto.grpc.irregular.Message.repeated_message:type_name -> goproto.grpc.irregular.IrregularMessage
	3,  // 2: goproto.grpc.irregular.Message.required_message:type_name -> goproto.grpc.irregular.IrregularMessage
	1,  // 3: goproto.grpc.irregular.Message.map_message:type_name -> goproto.grpc.irregular.Message.MapMessageEntry
	3,  // 4: goproto.grpc.irregular.Message.oneof_message:type_name -> goproto.grpc.irregular.IrregularMessage
	4,  // 5: goproto.grpc.irregular.Message.oneof_aberrant_message:type_name -> goproto.grpc.irregular.AberrantMessage
	4,  // 6: goproto.grpc.irregular.Message.optional_aberrant_message:type_name -> goproto.grpc.irregular.AberrantMessage
	4,  // 7: goproto.grpc.irregular.Message.repeated_aberrant_message:type_name -> goproto.grpc.irregular.AberrantMessage
	4,  // 8: goproto.grpc.irregular.Message.required_aberrant_message:type_name -> goproto.grpc.irregular.AberrantMessage
	2,  // 9: goproto.grpc.irregular.Message.map_aberrant_message:type_name -> goproto.grpc.irregular.Message.MapAberrantMessageEntry
	3,  // 10: goproto.grpc.irregular.Message.MapMessageEntry.value:type_name -> goproto.grpc.irregular.IrregularMessage
	4,  // 11: goproto.grpc.irregular.Message.MapAberrantMessageEntry.value:type_name -> goproto.grpc.irregular.AberrantMessage
