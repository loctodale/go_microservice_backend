...
// Test both logging in with a certs, and also that the certificate presented by an OpenSSH host can be validated correctly
func TestCertLogin(t *testing.T) {
	s := newServer(t)

	// Use a certs different from the default.
