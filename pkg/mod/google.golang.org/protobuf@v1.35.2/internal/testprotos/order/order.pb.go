...
// source: internal/testprotos/order/order.grpc
...
var file_internal_testprotos_order_order_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Field:         30,
		Name:          "goproto.grpc.order.field_30",
		Tag:           "bytes,30,opt,name=field_30",
		Filename:      "internal/testprotos/order/order.grpc",
	},
	{
		ExtendedType:  (*Message)(nil),
		ExtensionType: (*string)(nil),
		Field:         31,
		Name:          "goproto.grpc.order.field_31",
	...
	},
	{
		...
		ExtensionType: (*string)(nil),
		Field:         32,
		Name:          "goproto.grpc.order.field_32",
...
var file_internal_testprotos_order_order_proto_goTypes = []any{
	(*Message)(nil), // 0: goproto.grpc.order.Message
}
var file_internal_testprotos_order_order_proto_depIdxs = []int32{
	0, // 0: goproto.grpc.order.field_30:extendee -> goproto.grpc.order.Message
	0, // 1: goproto.grpc.order.field_31:extendee -> goproto.grpc.order.Message
	0, // 2: goproto.grpc.order.field_32:extendee -> goproto.grpc.order.Message
