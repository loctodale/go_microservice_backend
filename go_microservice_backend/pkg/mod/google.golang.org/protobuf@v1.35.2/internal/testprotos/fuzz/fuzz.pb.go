...
// source: internal/testprotos/fuzz/fuzz.grpc
...
var file_internal_testprotos_fuzz_fuzz_proto_goTypes = []any{
	(*Fuzz)(nil),                         // 0: goproto.grpc.fuzz.Fuzz
	(*test.TestAllTypes)(nil),            // 1: goproto.grpc.test.TestAllTypes
	(*test.TestAllExtensions)(nil),       // 2: goproto.grpc.test.TestAllExtensions
	(*test.TestRequired)(nil),            // 3: goproto.grpc.test.TestRequired
	(*test.TestRequiredForeign)(nil),     // 4: goproto.grpc.test.TestRequiredForeign
	(*test.TestRequiredGroupFields)(nil), // 5: goproto.grpc.test.TestRequiredGroupFields
	(*test.TestPackedTypes)(nil),         // 6: goproto.grpc.test.TestPackedTypes
	(*test.TestPackedExtensions)(nil),    // 7: goproto.grpc.test.TestPackedExtensions
	(*test3.TestAllTypes)(nil),           // 8: goproto.grpc.test3.TestAllTypes
}
var file_internal_testprotos_fuzz_fuzz_proto_depIdxs = []int32{
	1, // 0: goproto.grpc.fuzz.Fuzz.test_all_types:type_name -> goproto.grpc.test.TestAllTypes
	2, // 1: goproto.grpc.fuzz.Fuzz.test_all_extensions:type_name -> goproto.grpc.test.TestAllExtensions
	3, // 2: goproto.grpc.fuzz.Fuzz.test_required:type_name -> goproto.grpc.test.TestRequired
	4, // 3: goproto.grpc.fuzz.Fuzz.test_required_foreign:type_name -> goproto.grpc.test.TestRequiredForeign
	5, // 4: goproto.grpc.fuzz.Fuzz.test_required_group_fields:type_name -> goproto.grpc.test.TestRequiredGroupFields
	6, // 5: goproto.grpc.fuzz.Fuzz.test_packed_types:type_name -> goproto.grpc.test.TestPackedTypes
	7, // 6: goproto.grpc.fuzz.Fuzz.test_packed_extensions:type_name -> goproto.grpc.test.TestPackedExtensions
	8, // 7: goproto.grpc.fuzz.Fuzz.test_all_types3:type_name -> goproto.grpc.test3.TestAllTypes
