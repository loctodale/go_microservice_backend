...
// renewing a single domain's certs.
...
// start starts a certs renewal timer at the time
...
// stop stops the certs renewal timer and waits for any in-flight calls to renew
...
func (dr *domainRenewal) renew() {
	...
	defer cancel()
	// TODO: rotate dr.certs at some point?
	next, err := dr.do(ctx)
	if err != nil {
		next = renewJitter / 2
...
// state. It additionally updates dr.certs with the given state's key.
...
// cached certs is far enough in the future.
//
