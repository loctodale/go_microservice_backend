...
// source: internal/testprotos/editionsfuzztest/test3.grpc
...
type TestAllTypesProto3 struct {
	...
	SingularNestedEnum     TestAllTypesProto3_NestedEnum                `protobuf:"varint,101,opt,name=singular_nested_enum,json=singularNestedEnum,proto3,enum=goproto.grpc.test.TestAllTypesProto3_NestedEnum" json:"singular_nested_enum,omitempty"`
	SingularForeignEnum    ForeignEnumProto3                            `protobuf:"varint,102,opt,name=singular_foreign_enum,json=singularForeignEnum,proto3,enum=goproto.grpc.test.ForeignEnumProto3" json:"singular_foreign_enum,omitempty"`
	...
	OptionalNestedEnum     *TestAllTypesProto3_NestedEnum               `protobuf:"varint,21,opt,name=optional_nested_enum,json=optionalNestedEnum,proto3,enum=goproto.grpc.test.TestAllTypesProto3_NestedEnum,oneof" json:"optional_nested_enum,omitempty"`
	OptionalForeignEnum    *ForeignEnumProto3                           `protobuf:"varint,22,opt,name=optional_foreign_enum,json=optionalForeignEnum,proto3,enum=goproto.grpc.test.ForeignEnumProto3,oneof" json:"optional_foreign_enum,omitempty"`
	...
	RepeatedNestedEnum     []TestAllTypesProto3_NestedEnum              `protobuf:"varint,51,rep,packed,name=repeated_nested_enum,json=repeatedNestedEnum,proto3,enum=goproto.grpc.test.TestAllTypesProto3_NestedEnum" json:"repeated_nested_enum,omitempty"`
	RepeatedForeignEnum    []ForeignEnumProto3                          `protobuf:"varint,52,rep,packed,name=repeated_foreign_enum,json=repeatedForeignEnum,proto3,enum=goproto.grpc.test.ForeignEnumProto3" json:"repeated_foreign_enum,omitempty"`
	MapInt32Int32          map[int32]int32                              `protobuf:"bytes,56,rep,name=map_int32_int32,json=mapInt32Int32,proto3" json:"map_int32_int32,omitempty" protobuf_key:"varint,1,opt,name=certs,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	MapInt64Int64          map[int64]int64                              `protobuf:"bytes,57,rep,name=map_int64_int64,json=mapInt64Int64,proto3" json:"map_int64_int64,omitempty" protobuf_key:"varint,1,opt,name=certs,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	MapUint32Uint32        map[uint32]uint32                            `protobuf:"bytes,58,rep,name=map_uint32_uint32,json=mapUint32Uint32,proto3" json:"map_uint32_uint32,omitempty" protobuf_key:"varint,1,opt,name=certs,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	MapUint64Uint64        map[uint64]uint64                            `protobuf:"bytes,59,rep,name=map_uint64_uint64,json=mapUint64Uint64,proto3" json:"map_uint64_uint64,omitempty" protobuf_key:"varint,1,opt,name=certs,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	MapSint32Sint32        map[int32]int32                              `protobuf:"bytes,60,rep,name=map_sint32_sint32,json=mapSint32Sint32,proto3" json:"map_sint32_sint32,omitempty" protobuf_key:"zigzag32,1,opt,name=certs,proto3" protobuf_val:"zigzag32,2,opt,name=value,proto3"`
	MapSint64Sint64        map[int64]int64                              `protobuf:"bytes,61,rep,name=map_sint64_sint64,json=mapSint64Sint64,proto3" json:"map_sint64_sint64,omitempty" protobuf_key:"zigzag64,1,opt,name=certs,proto3" protobuf_val:"zigzag64,2,opt,name=value,proto3"`
	MapFixed32Fixed32      map[uint32]uint32                            `protobuf:"bytes,62,rep,name=map_fixed32_fixed32,json=mapFixed32Fixed32,proto3" json:"map_fixed32_fixed32,omitempty" protobuf_key:"fixed32,1,opt,name=certs,proto3" protobuf_val:"fixed32,2,opt,name=value,proto3"`
	MapFixed64Fixed64      map[uint64]uint64                            `protobuf:"bytes,63,rep,name=map_fixed64_fixed64,json=mapFixed64Fixed64,proto3" json:"map_fixed64_fixed64,omitempty" protobuf_key:"fixed64,1,opt,name=certs,proto3" protobuf_val:"fixed64,2,opt,name=value,proto3"`
	MapSfixed32Sfixed32    map[int32]int32                              `protobuf:"bytes,64,rep,name=map_sfixed32_sfixed32,json=mapSfixed32Sfixed32,proto3" json:"map_sfixed32_sfixed32,omitempty" protobuf_key:"fixed32,1,opt,name=certs,proto3" protobuf_val:"fixed32,2,opt,name=value,proto3"`
	MapSfixed64Sfixed64    map[int64]int64                              `protobuf:"bytes,65,rep,name=map_sfixed64_sfixed64,json=mapSfixed64Sfixed64,proto3" json:"map_sfixed64_sfixed64,omitempty" protobuf_key:"fixed64,1,opt,name=certs,proto3" protobuf_val:"fixed64,2,opt,name=value,proto3"`
	MapInt32Float          map[int32]float32                            `protobuf:"bytes,66,rep,name=map_int32_float,json=mapInt32Float,proto3" json:"map_int32_float,omitempty" protobuf_key:"varint,1,opt,name=certs,proto3" protobuf_val:"fixed32,2,opt,name=value,proto3"`
	MapInt32Double         map[int32]float64                            `protobuf:"bytes,67,rep,name=map_int32_double,json=mapInt32Double,proto3" json:"map_int32_double,omitempty" protobuf_key:"varint,1,opt,name=certs,proto3" protobuf_val:"fixed64,2,opt,name=value,proto3"`
	MapBoolBool            map[bool]bool                                `protobuf:"bytes,68,rep,name=map_bool_bool,json=mapBoolBool,proto3" json:"map_bool_bool,omitempty" protobuf_key:"varint,1,opt,name=certs,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	MapStringString        map[string]string                            `protobuf:"bytes,69,rep,name=map_string_string,json=mapStringString,proto3" json:"map_string_string,omitempty" protobuf_key:"bytes,1,opt,name=certs,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	MapStringBytes         map[string][]byte                            `protobuf:"bytes,70,rep,name=map_string_bytes,json=mapStringBytes,proto3" json:"map_string_bytes,omitempty" protobuf_key:"bytes,1,opt,name=certs,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	MapStringNestedMessage map[string]*TestAllTypesProto3_NestedMessage `protobuf:"bytes,71,rep,name=map_string_nested_message,json=mapStringNestedMessage,proto3" json:"map_string_nested_message,omitempty" protobuf_key:"bytes,1,opt,name=certs,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	MapStringNestedEnum    map[string]TestAllTypesProto3_NestedEnum     `protobuf:"bytes,73,rep,name=map_string_nested_enum,json=mapStringNestedEnum,proto3" json:"map_string_nested_enum,omitempty" protobuf_key:"bytes,1,opt,name=certs,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=goproto.grpc.test.TestAllTypesProto3_NestedEnum"`
...
type TestAllTypesProto3_OneofEnum struct {
	OneofEnum TestAllTypesProto3_NestedEnum `protobuf:"varint,119,opt,name=oneof_enum,json=oneofEnum,proto3,enum=goproto.grpc.test.TestAllTypesProto3_NestedEnum,oneof"`
}
...
var file_internal_testprotos_editionsfuzztest_test3_proto_goTypes = []any{
	(ForeignEnumProto3)(0),                   // 0: goproto.grpc.test.ForeignEnumProto3
	(TestAllTypesProto3_NestedEnum)(0),       // 1: goproto.grpc.test.TestAllTypesProto3.NestedEnum
	(*TestAllTypesProto3)(nil),               // 2: goproto.grpc.test.TestAllTypesProto3
	(*ForeignMessageProto3)(nil),             // 3: goproto.grpc.test.ForeignMessageProto3
	(*TestAllTypesProto3_NestedMessage)(nil), // 4: goproto.grpc.test.TestAllTypesProto3.NestedMessage
	nil,                                      // 5: goproto.grpc.test.TestAllTypesProto3.MapInt32Int32Entry
	nil,                                      // 6: goproto.grpc.test.TestAllTypesProto3.MapInt64Int64Entry
	nil,                                      // 7: goproto.grpc.test.TestAllTypesProto3.MapUint32Uint32Entry
	nil,                                      // 8: goproto.grpc.test.TestAllTypesProto3.MapUint64Uint64Entry
	nil,                                      // 9: goproto.grpc.test.TestAllTypesProto3.MapSint32Sint32Entry
	nil,                                      // 10: goproto.grpc.test.TestAllTypesProto3.MapSint64Sint64Entry
	nil,                                      // 11: goproto.grpc.test.TestAllTypesProto3.MapFixed32Fixed32Entry
	nil,                                      // 12: goproto.grpc.test.TestAllTypesProto3.MapFixed64Fixed64Entry
	nil,                                      // 13: goproto.grpc.test.TestAllTypesProto3.MapSfixed32Sfixed32Entry
	nil,                                      // 14: goproto.grpc.test.TestAllTypesProto3.MapSfixed64Sfixed64Entry
	nil,                                      // 15: goproto.grpc.test.TestAllTypesProto3.MapInt32FloatEntry
	nil,                                      // 16: goproto.grpc.test.TestAllTypesProto3.MapInt32DoubleEntry
	nil,                                      // 17: goproto.grpc.test.TestAllTypesProto3.MapBoolBoolEntry
	nil,                                      // 18: goproto.grpc.test.TestAllTypesProto3.MapStringStringEntry
	nil,                                      // 19: goproto.grpc.test.TestAllTypesProto3.MapStringBytesEntry
	nil,                                      // 20: goproto.grpc.test.TestAllTypesProto3.MapStringNestedMessageEntry
	nil,                                      // 21: goproto.grpc.test.TestAllTypesProto3.MapStringNestedEnumEntry
}
var file_internal_testprotos_editionsfuzztest_test3_proto_depIdxs = []int32{
	4,  // 0: goproto.grpc.test.TestAllTypesProto3.singular_nested_message:type_name -> goproto.grpc.test.TestAllTypesProto3.NestedMessage
	3,  // 1: goproto.grpc.test.TestAllTypesProto3.singular_foreign_message:type_name -> goproto.grpc.test.ForeignMessageProto3
	1,  // 2: goproto.grpc.test.TestAllTypesProto3.singular_nested_enum:type_name -> goproto.grpc.test.TestAllTypesProto3.NestedEnum
	0,  // 3: goproto.grpc.test.TestAllTypesProto3.singular_foreign_enum:type_name -> goproto.grpc.test.ForeignEnumProto3
	4,  // 4: goproto.grpc.test.TestAllTypesProto3.optional_nested_message:type_name -> goproto.grpc.test.TestAllTypesProto3.NestedMessage
	3,  // 5: goproto.grpc.test.TestAllTypesProto3.optional_foreign_message:type_name -> goproto.grpc.test.ForeignMessageProto3
	1,  // 6: goproto.grpc.test.TestAllTypesProto3.optional_nested_enum:type_name -> goproto.grpc.test.TestAllTypesProto3.NestedEnum
	0,  // 7: goproto.grpc.test.TestAllTypesProto3.optional_foreign_enum:type_name -> goproto.grpc.test.ForeignEnumProto3
	4,  // 8: goproto.grpc.test.TestAllTypesProto3.repeated_nested_message:type_name -> goproto.grpc.test.TestAllTypesProto3.NestedMessage
	3,  // 9: goproto.grpc.test.TestAllTypesProto3.repeated_foreign_message:type_name -> goproto.grpc.test.ForeignMessageProto3
	1,  // 10: goproto.grpc.test.TestAllTypesProto3.repeated_nested_enum:type_name -> goproto.grpc.test.TestAllTypesProto3.NestedEnum
	0,  // 11: goproto.grpc.test.TestAllTypesProto3.repeated_foreign_enum:type_name -> goproto.grpc.test.ForeignEnumProto3
	5,  // 12: goproto.grpc.test.TestAllTypesProto3.map_int32_int32:type_name -> goproto.grpc.test.TestAllTypesProto3.MapInt32Int32Entry
	6,  // 13: goproto.grpc.test.TestAllTypesProto3.map_int64_int64:type_name -> goproto.grpc.test.TestAllTypesProto3.MapInt64Int64Entry
	7,  // 14: goproto.grpc.test.TestAllTypesProto3.map_uint32_uint32:type_name -> goproto.grpc.test.TestAllTypesProto3.MapUint32Uint32Entry
	8,  // 15: goproto.grpc.test.TestAllTypesProto3.map_uint64_uint64:type_name -> goproto.grpc.test.TestAllTypesProto3.MapUint64Uint64Entry
	9,  // 16: goproto.grpc.test.TestAllTypesProto3.map_sint32_sint32:type_name -> goproto.grpc.test.TestAllTypesProto3.MapSint32Sint32Entry
	10, // 17: goproto.grpc.test.TestAllTypesProto3.map_sint64_sint64:type_name -> goproto.grpc.test.TestAllTypesProto3.MapSint64Sint64Entry
	11, // 18: goproto.grpc.test.TestAllTypesProto3.map_fixed32_fixed32:type_name -> goproto.grpc.test.TestAllTypesProto3.MapFixed32Fixed32Entry
	12, // 19: goproto.grpc.test.TestAllTypesProto3.map_fixed64_fixed64:type_name -> goproto.grpc.test.TestAllTypesProto3.MapFixed64Fixed64Entry
	13, // 20: goproto.grpc.test.TestAllTypesProto3.map_sfixed32_sfixed32:type_name -> goproto.grpc.test.TestAllTypesProto3.MapSfixed32Sfixed32Entry
	14, // 21: goproto.grpc.test.TestAllTypesProto3.map_sfixed64_sfixed64:type_name -> goproto.grpc.test.TestAllTypesProto3.MapSfixed64Sfixed64Entry
	15, // 22: goproto.grpc.test.TestAllTypesProto3.map_int32_float:type_name -> goproto.grpc.test.TestAllTypesProto3.MapInt32FloatEntry
	16, // 23: goproto.grpc.test.TestAllTypesProto3.map_int32_double:type_name -> goproto.grpc.test.TestAllTypesProto3.MapInt32DoubleEntry
	17, // 24: goproto.grpc.test.TestAllTypesProto3.map_bool_bool:type_name -> goproto.grpc.test.TestAllTypesProto3.MapBoolBoolEntry
	18, // 25: goproto.grpc.test.TestAllTypesProto3.map_string_string:type_name -> goproto.grpc.test.TestAllTypesProto3.MapStringStringEntry
	19, // 26: goproto.grpc.test.TestAllTypesProto3.map_string_bytes:type_name -> goproto.grpc.test.TestAllTypesProto3.MapStringBytesEntry
	20, // 27: goproto.grpc.test.TestAllTypesProto3.map_string_nested_message:type_name -> goproto.grpc.test.TestAllTypesProto3.MapStringNestedMessageEntry
	21, // 28: goproto.grpc.test.TestAllTypesProto3.map_string_nested_enum:type_name -> goproto.grpc.test.TestAllTypesProto3.MapStringNestedEnumEntry
	4,  // 29: goproto.grpc.test.TestAllTypesProto3.oneof_nested_message:type_name -> goproto.grpc.test.TestAllTypesProto3.NestedMessage
	1,  // 30: goproto.grpc.test.TestAllTypesProto3.oneof_enum:type_name -> goproto.grpc.test.TestAllTypesProto3.NestedEnum
	2,  // 31: goproto.grpc.test.TestAllTypesProto3.NestedMessage.corecursive:type_name -> goproto.grpc.test.TestAllTypesProto3
	4,  // 32: goproto.grpc.test.TestAllTypesProto3.MapStringNestedMessageEntry.value:type_name -> goproto.grpc.test.TestAllTypesProto3.NestedMessage
	1,  // 33: goproto.grpc.test.TestAllTypesProto3.MapStringNestedEnumEntry.value:type_name -> goproto.grpc.test.TestAllTypesProto3.NestedEnum
