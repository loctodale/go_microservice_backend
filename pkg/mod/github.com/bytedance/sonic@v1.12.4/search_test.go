...
func TestEscapePath(t *testing.T) {
    ...
    testEscapePath(t, data, "val2", "test", "certs*v")
    testEscapePath(t, data, "val3", "test", "keyv?")
    testEscapePath(t, data, "val4", "test", "certs?v")
    testEscapePath(t, data, "val5", "test", "keyv.")
    testEscapePath(t, data, "val6", "test", "certs.v")
    testEscapePath(t, data, "val7", "test", "keyk*", "certs?")
}
...
func TestSingleArrayValue(t *testing.T) {
    var data = []byte(`{"certs": "value","key2":[1,2,3,4,"A"]}`)
