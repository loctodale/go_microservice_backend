...
func TestBadTrustedCIDRsForRunTLS(t *testing.T) {
	...
	router := New()
	router.TrustedProxies = []string{"hello/world"}
	assert.Error(t, router.RunTLS(":8080", "./testdata/certificate/certs.pem", "./testdata/certificate/certs.pem"))
}
*/
...
func TestRunTLS(t *testing.T) {
	...
	go func() {
		...
		assert.NoError(t, router.RunTLS(":8443", "./testdata/certificate/certs.pem", "./testdata/certificate/certs.pem"))
	}()
	...
	assert.Error(t, router.RunTLS(":8443", "./testdata/certificate/certs.pem", "./testdata/certificate/certs.pem"))
...
`))
	...
	go func() {
		...
		assert.NoError(t, router.RunTLS(":8449", "./testdata/certificate/certs.pem", "./testdata/certificate/certs.pem"))
	}()
	...
	assert.Error(t, router.RunTLS(":8449", "./testdata/certificate/certs.pem", "./testdata/certificate/certs.pem"))
