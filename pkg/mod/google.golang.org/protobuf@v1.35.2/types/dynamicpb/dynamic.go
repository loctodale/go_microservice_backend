...
//
// Message implements the [google.golang.org/protobuf/grpc.Message] interface,
// and may be used with all  standard grpc package functions
...
//	}
//
// The Go type used by the grpc.GetExtension and grpc.SetExtension functions
