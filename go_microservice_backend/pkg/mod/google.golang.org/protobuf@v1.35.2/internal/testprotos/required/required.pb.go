...
// source: internal/testprotos/required/required.grpc
...
var file_internal_testprotos_required_required_proto_goTypes = []any{
	(*Int32)(nil),       // 0: goproto.grpc.testrequired.Int32
	(*Int64)(nil),       // 1: goproto.grpc.testrequired.Int64
	(*Uint32)(nil),      // 2: goproto.grpc.testrequired.Uint32
	(*Uint64)(nil),      // 3: goproto.grpc.testrequired.Uint64
	(*Sint32)(nil),      // 4: goproto.grpc.testrequired.Sint32
	(*Sint64)(nil),      // 5: goproto.grpc.testrequired.Sint64
	(*Fixed32)(nil),     // 6: goproto.grpc.testrequired.Fixed32
	(*Fixed64)(nil),     // 7: goproto.grpc.testrequired.Fixed64
	(*Float)(nil),       // 8: goproto.grpc.testrequired.Float
	(*Double)(nil),      // 9: goproto.grpc.testrequired.Double
	(*Bool)(nil),        // 10: goproto.grpc.testrequired.Bool
	(*String)(nil),      // 11: goproto.grpc.testrequired.String
	(*Bytes)(nil),       // 12: goproto.grpc.testrequired.Bytes
	(*Message)(nil),     // 13: goproto.grpc.testrequired.Message
	(*Group)(nil),       // 14: goproto.grpc.testrequired.Group
	(*Message_M)(nil),   // 15: goproto.grpc.testrequired.Message.M
	(*Group_Group)(nil), // 16: goproto.grpc.testrequired.Group.Group
}
var file_internal_testprotos_required_required_proto_depIdxs = []int32{
	15, // 0: goproto.grpc.testrequired.Message.v:type_name -> goproto.grpc.testrequired.Message.M
	16, // 1: goproto.grpc.testrequired.Group.group:type_name -> goproto.grpc.testrequired.Group.Group
