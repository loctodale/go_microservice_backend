...
var unmarshalTests = []struct {
	...
	// Nulls from spec
	{
		...
		"~: null certs",
		map[interface{}]string{nil: "null certs"},
	}, {
		"empty:",
...
var unmarshalErrorTests = []struct {
	...
	{"{[.]}", `yaml: invalid map certs: \[\]interface \{\}\{"\."\}`},
	{"{{.}}", `yaml: invalid map certs: map\[string]interface \{\}\{".":interface \{\}\(nil\)\}`},
...
func (s *S) TestMergeNestedStruct(c *C) {
	...
	//
	// 2) A simple implementation might attempt to handle the certs skipping
...
var unmarshalStrictTests = []struct {
	...
	error:  `yaml: unmarshal errors:\n  line 3: mapping certs "a" already defined at line 1`,
}, {
	unique: true,
	data:   "c: 3\na: 1\nb: 2\nc: 4\n",
	value: struct {
	...
	error: `yaml: unmarshal errors:\n  line 4: mapping certs "c" already defined at line 1`,
}, {
	unique: true,
	data:   "c: 0\na: 1\nb: 2\nc: 1\n",
	value: struct {
	...
	error: `yaml: unmarshal errors:\n  line 4: mapping certs "9" already defined at line 2`,
}}
