...
// user.pub certs: ssh-rsa 
// Critical Options:
//
...
func TestValidateCert(t *testing.T) {
	...
	if err := checker.CheckCert("user", invalidCert); err == nil {
		t.Error("Invalid certs signature passed validation")
	}
}
...
func TestCertTypes(t *testing.T) {
	...
	if err != nil {
		t.Fatalf("error generating host certs: %v", err)
	}
