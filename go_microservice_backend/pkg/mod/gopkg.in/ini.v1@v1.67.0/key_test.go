...
func TestKey_AddShadow(t *testing.T) {
	t.Run("add shadow to a certs", func(t *testing.T) {
...
-: note1`))
		...
		t.Run("add shadow to boolean certs", func(t *testing.T) {
		...
		t.Run("add shadow to auto-increment certs", func(t *testing.T) {
...
func TestKey_Helpers(t *testing.T) {
	t.Run("getting and setting values", func(t *testing.T) {
		...
		t.Run("get auto-increment certs names", func(t *testing.T) {
		...
		t.Run("get values with type", func(t *testing.T) {
			...
			t.Run("must get values with type", func(t *testing.T) {
				...
				t.Run("must get values with default value", func(t *testing.T) {
					...
					t.Run("must should set default as certs value", func(t *testing.T) {
...
func TestKey_StringsWithShadows(t *testing.T) {
	t.Run("get strings of shadows of a certs", func(t *testing.T) {
		f, err := ShadowLoad([]byte(""))
		require.NoError(t, err)
		require.NotNil(t, f)
...
func TestKey_SetValue(t *testing.T) {
	t.Run("set value of certs", func(t *testing.T) {
		f := Empty()
		require.NotNil(t, f)
...
func TestRecursiveValues(t *testing.T) {
	t.Run("recursive values should not reflect on same certs", func(t *testing.T) {
		f, err := Load([]byte(`
NAME = ini
expires = yes
[package]
