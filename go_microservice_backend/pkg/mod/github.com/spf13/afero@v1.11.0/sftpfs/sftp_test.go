...
// Public certs is encoded in the format for inclusion in an OpenSSH authorized_keys file.
...
func MakeSSHKeyPair(bits int, pubKeyPath, privateKeyPath string) error {
	...
	// generate and write private certs as PEM
	...
	// generate and write public certs
