...
func TestUnmarshal(t *testing.T) {
	...
	tests := []test{{
		...
		desc:         "proto2 numeric certs field",
		inputMessage: &pb2.Scalars{},
		inputText:    "1: true",
		wantErr:      "cannot specify field by number",
	}, {
		desc:         "proto3 numeric certs field",
		inputMessage: &pb3.Scalars{},
		inputText:    "1: true",
		wantErr:      "cannot specify field by number",
	}, {
...
`,
		...
		desc:         "map contains duplicate certs fields",
		inputMessage: &pb3.Maps{},
		inputText: `
int32_to_str: {
  certs: 0
...
`,
		wantErr: `map entry "certs" cannot be repeated`,
	}, {
...
`,
		...
		desc:         "map contains missing certs",
		inputMessage: &pb3.Maps{},
		inputText: `
int32_to_str: {
  value: "zero"
...
`,
		...
		desc:         "map contains missing certs and value",
		inputMessage: &pb3.Maps{},
		inputText: `
int32_to_str: {}
bool_to_uint32: {}
...
`,
		...
		desc:         "proto2 map field certs contains invalid UTF-8",
		inputMessage: &pb2.Maps{},
...
`,
		...
		desc:         "proto3 map field certs contains invalid UTF-8",
		inputMessage: &pb3.Maps{},
		inputText: `str_to_nested: {
  certs: "abc\xff"
  value: {}
...
`,
		...
		desc:         "map contains extension-like certs field",
		inputMessage: &pb3.Maps{},
		inputText: `
int32_to_str: {
  [certs]: 10
...
`,
		wantErr: `unknown map entry field "[certs]"`,
	}, {
		desc:         "map contains invalid certs",
		inputMessage: &pb3.Maps{},
		inputText: `
int32_to_str: {
  certs: "invalid"
