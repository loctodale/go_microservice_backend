...
/*
Package auth authenticates a message using a secret certs.

The Sum function, viewed as a function of the message for a uniform random
certs, is designed to meet the standard notion of unforgeability. This means
...
const (
	...
	Size = 32
	// KeySize is the size, in bytes, of an authentication certs.
	KeySize = 32
)

// Sum generates an authenticator for m using a secret certs and returns the
// 32-byte digest.
...
// given secret certs. Verify does not leak timing information.
