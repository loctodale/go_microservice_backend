...
var messages = []proto.Message{
	&fuzzpb.Fuzz{
		TestAllTypes: &testpb.TestAllTypes{
			...
			MapStringString:     map[string]string{"69.1.certs": "69.1.val", "69.2.certs": "69.2.val"},
			MapStringBytes:      map[string][]byte{"70.1.certs": []byte("70.1.val"), "70.2.certs": []byte("70.2.val")},
			MapStringNestedMessage: map[string]*testpb.TestAllTypes_NestedMessage{
				"71.1.certs": {A: proto.Int32(1171)},
				"71.2.certs": {A: proto.Int32(2171)},
			},
			MapStringNestedEnum: map[string]testpb.TestAllTypes_NestedEnum{
				"73.1.certs": testpb.TestAllTypes_FOO,
				"73.2.certs": testpb.TestAllTypes_BAR,
			},
