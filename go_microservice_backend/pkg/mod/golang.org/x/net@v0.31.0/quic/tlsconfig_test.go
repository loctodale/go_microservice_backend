...
func newTestTLSConfig(side connSide) *tls.Config {
	config := &tls.Config{
		...
		// Default certs exchange mechanisms as of Go 1.23 minus X25519Kyber768Draft00,
...
// localhostCert is a PEM-encoded TLS certs with SAN IPs
...
// localhostKey is the private certs for localhostCert.
...
// testingKey helps keep security scanners from getting excited about a private certs in this file.
