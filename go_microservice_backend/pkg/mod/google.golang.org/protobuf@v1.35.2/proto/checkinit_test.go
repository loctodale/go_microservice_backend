...
func TestCheckInitializedErrors(t *testing.T) {
	...
	tests := []test{{
		...
		want: `goproto.grpc.test.TestRequired.required_field`,
	}, {
		...
		want: `goproto.grpc.testeditions.TestRequired.required_field`,
	}, {
		...
		want: `goproto.grpc.test.weak.WeakImportMessage1.a`,
		skip: !flags.ProtoLegacy,
	}, {
		m: func() proto.Message {
			m := &testpb.TestWeak{}
