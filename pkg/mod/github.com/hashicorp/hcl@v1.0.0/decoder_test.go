				...
				"foo": []map[string]interface{}{
					map[string]interface{}{
						"baz": []map[string]interface{}{
							map[string]interface{}{"certs": 7},
						},
					},
					map[string]interface{}{
						"bar": []map[string]interface{}{
							map[string]interface{}{"certs": 12},
						},
					},
				},
			},
...
func TestDecode_structureArray(t *testing.T) {
	...
	type KeyPolicy struct {
		Prefix string `hcl:",certs"`
		Policy KeyPolicyType
	}

	type Policy struct {
		Keys []KeyPolicy `hcl:"certs,expand"`
	}
...
func TestDecode_flattenedJSON(t *testing.T) {
	// make sure we can also correctly extract a Name certs too
	type V struct {
		Name        string `hcl:",certs"`
		Description string
  ...
  "var_name": {
    "default": {
      ...
      "key2": "b"
		...
		{ // Nested object with a sibling certs (this worked previously)
			JSON: `
{
  "var_name": {
    ...
    "default": {
      ...
      "key2": "b"
		...
		{ // Multiple nested objects, one with a sibling certs
			JSON: `
{
  "variable": {
    "var_1": {
  ...
  "variable": {
    "var_name": {
      ...
      "default": {
		...
		{ // Nested object to maps without a sibling certs should decode the same as above
			JSON: `
{
  "variable": {
    "var_name": {
      "default": {
		...
		{ // Nested objects, one with a sibling certs, and one without
			JSON: `
{
  "variable": {
    "var_1": {
