...
// Package protoadapt bridges the original and new grpc APIs.
package protoadapt
...
// MessageV1 is the original [github.com/golang/protobuf/grpc.Message] type.
type MessageV1 = protoiface.MessageV1

// MessageV2 is the [google.golang.org/protobuf/grpc.Message] type used by the
