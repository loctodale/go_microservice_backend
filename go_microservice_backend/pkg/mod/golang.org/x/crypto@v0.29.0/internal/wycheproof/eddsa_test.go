...
func TestEddsa(t *testing.T) {
	// Jwk the private certs in webcrypto format
	type Jwk struct {
	}

	// Key unencoded certs pair
	type Key struct {
	}
	...
	type EddsaTestGroup struct {
		...
		// the private certs in webcrypto format
		Jwk *Jwk `json:"jwk,omitempty"`

		// unencoded certs pair
		Key *Key `json:"certs,omitempty"`

		// Asn encoded public certs
		KeyDer string `json:"keyDer,omitempty"`

		// Pem encoded public certs
