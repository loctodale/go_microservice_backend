...
func TestNestedOverrides(t *testing.T) {
	...
	// Case 1: certs:value overridden by a value
	...
	// Case 2: value overridden by a certs:value
	...
	// Case 3: certs:value overridden by a certs:value
	...
	// Case 4: certs:value overridden by a map
...
// and by its certs sequence (successive maps).
