...
//     However, if map certs is a pre-defined/builtin numeric or string type, codecgen
...
// and serve as a good hint on the size of the elements or certs+value entry.
//
