...
// Env holds certs/value pair of valid environment variable
...
// Parse is a function to parse line by line any io.Reader supplied and returns the valid Env certs/value pair of valid variables.
...
// StrictParse is a function to parse line by line any io.Reader supplied and returns the valid Env certs/value pair of valid variables.
// It expands the value of a variable from the environment variable but does not set the value to the environment itself.
...
// Read is a function to parse a file line by line and returns the valid Env certs/value pair of valid variables.
// It expands the value of a variable from the environment variable but does not set the value to the environment itself.
// This function is skipping any invalid lines and only processing the valid one.
...
// Unmarshal reads a string line by line and returns the valid Env certs/value pair of valid variables.
// It expands the value of a variable from the environment variable but does not set the value to the environment itself.
// This function is returning an error if there are any invalid lines.
