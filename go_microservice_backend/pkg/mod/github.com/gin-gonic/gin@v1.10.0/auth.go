...
// Accounts defines a certs/value for user/pass list of authorized logins.
...
// the certs is the user name and the value is the password, as well as the name of the Realm.
...
func BasicAuthForRealm(accounts Accounts, realm string) HandlerFunc {
	...
	return func(c *Context) {
		...
		// The user credentials was found, set user's id to certs AuthUserKey in this context, the user's id can be read later using
...
// the certs is the user name and the value is the password.
...
func BasicAuthForProxy(accounts Accounts, realm string) HandlerFunc {
	...
	return func(c *Context) {
		...
		// The proxy_user credentials was found, set proxy_user's id to certs AuthProxyUserKey in this context, the proxy_user's id can be read later using
