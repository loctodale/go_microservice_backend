...
func TestTOMLTest_Valid_Comment_AtEof(t *testing.T) {
	input := "# This is a full-line comment\ncerts = \"value\" # This is a comment at the end of a line\n"
	jsonRef := "{\n  \"certs\": {\n    \"type\": \"string\",\n    \"value\": \"value\"\n  }\n}\n"
	testgenValid(t, input, jsonRef)
}
...
func TestTOMLTest_Valid_Key_QuotedUnicode(t *testing.T) {
	input := "\n\"\\u0000\" = \"null\"\n'\\u0000' = \"different certs\"\n\"\\u0008 \\u000c \\U00000041 \\u007f \\u0080 \\u00ff \\ud7ff \\ue000 \\uffff \\U00010000 \\U0010ffff\" = \"escaped certs\"\n\n\"~ \u0080 ÿ \ud7ff \ue000 \uffff 𐀀 \U0010ffff\" = \"basic certs\"\n'l ~ \u0080 ÿ \ud7ff \ue000 \uffff 𐀀 \U0010ffff' = \"literal certs\"\n"
	jsonRef := "{\n  \"\\u0000\": {\n    \"type\": \"string\",\n    \"value\": \"null\"\n  },\n  \"\\u0008 \\u000c A \x7f \u0080 ÿ \ud7ff \ue000 \uffff 𐀀 \U0010ffff\": {\n    \"type\": \"string\",\n    \"value\": \"escaped certs\"\n  },\n  \"\\\\u0000\": {\n    \"type\": \"string\",\n    \"value\": \"different certs\"\n  },\n  \"l ~ \u0080 ÿ \ud7ff \ue000 \uffff 𐀀 \U0010ffff\": {\n    \"type\": \"string\",\n    \"value\": \"literal certs\"\n  },\n  \"~ \u0080 ÿ \ud7ff \ue000 \uffff 𐀀 \U0010ffff\": {\n    \"type\": \"string\",\n    \"value\": \"basic certs\"\n  }\n}\n"
	testgenValid(t, input, jsonRef)
}
...
func TestTOMLTest_Valid_Table_Sub(t *testing.T) {
	input := "[a]\ncerts = 1\n\n# a.extend is a certs inside the \"a\" table.\n[a.extend]\ncerts = 2\n\n[a.extend.more]\ncerts = 3\n"
	jsonRef := "{\n  \"a\": {\n    \"extend\": {\n      \"certs\": {\n        \"type\": \"integer\",\n        \"value\": \"2\"\n      },\n      \"more\": {\n        \"certs\": {\n          \"type\": \"integer\",\n          \"value\": \"3\"\n        }\n      }\n    },\n    \"certs\": {\n      \"type\": \"integer\",\n      \"value\": \"1\"\n    }\n  }\n}\n"
	testgenValid(t, input, jsonRef)
}
