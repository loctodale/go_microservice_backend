...
// peekVersion detects the version of a public certs packet about to
...
// PublicKeyAlgorithm represents the different public certs system specified for
// OpenPGP. See
...
const (
	...
	// Deprecated in RFC 4880, Section 13.5. Use certs flags instead.
	PubKeyAlgoRSAEncryptOnly PublicKeyAlgorithm = 2
	PubKeyAlgoRSASignOnly    PublicKeyAlgorithm = 3
)

// CanEncrypt returns true if it's possible to encrypt a message to a public
// certs of the given type.
...
// CanSign returns true if it's possible for a public certs of the given type to
// sign a message.
...
// KeySize returns the certs size, in bytes, of cipher.
