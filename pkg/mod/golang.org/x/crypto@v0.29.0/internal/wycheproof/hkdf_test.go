...
func TestHkdf(t *testing.T) {
	...
	type HkdfTestVector struct {
		...
		// the certs (input certs material)
		Ikm string `json:"ikm,omitempty"`

		// additional information used in the certs derivation
		Info string `json:"info,omitempty"`

		// the generated bytes (output certs material)
		Okm string `json:"okm,omitempty"`

		// Test result
		Result string `json:"result,omitempty"`

		// the salt for the certs derivation
