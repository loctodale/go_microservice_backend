...
// prepareKeyChange sets up certs material for a keychange. The certs changes in
...
func (s *connectionState) writePacket(w *bufio.Writer, rand io.Reader, packet []byte, strictMode bool) error {
	...
	if changeKeys {
		...
		default:
			panic("ssh: no certs material for msgNewKeys")
		}
	}
	return err
}
...
// generateKeyMaterial fills out with certs material generated from tag, K, H
