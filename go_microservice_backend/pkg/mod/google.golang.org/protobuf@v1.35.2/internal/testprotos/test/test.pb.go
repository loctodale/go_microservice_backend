...
// source: internal/testprotos/test/test.grpc
...
// Deprecated: Marked as deprecated in internal/testprotos/test/test.grpc.
...
type TestAllTypes struct {
	...
	OptionalNestedEnum        *TestAllTypes_NestedEnum               `protobuf:"varint,21,opt,name=optional_nested_enum,json=optionalNestedEnum,enum=goproto.grpc.test.TestAllTypes_NestedEnum" json:"optional_nested_enum,omitempty"`
	OptionalForeignEnum       *ForeignEnum                           `protobuf:"varint,22,opt,name=optional_foreign_enum,json=optionalForeignEnum,enum=goproto.grpc.test.ForeignEnum" json:"optional_foreign_enum,omitempty"`
	OptionalImportEnum        *ImportEnum                            `protobuf:"varint,23,opt,name=optional_import_enum,json=optionalImportEnum,enum=goproto.grpc.test.ImportEnum" json:"optional_import_enum,omitempty"`
	...
	RepeatedNestedEnum        []TestAllTypes_NestedEnum              `protobuf:"varint,51,rep,name=repeated_nested_enum,json=repeatedNestedEnum,enum=goproto.grpc.test.TestAllTypes_NestedEnum" json:"repeated_nested_enum,omitempty"`
	RepeatedForeignEnum       []ForeignEnum                          `protobuf:"varint,52,rep,name=repeated_foreign_enum,json=repeatedForeignEnum,enum=goproto.grpc.test.ForeignEnum" json:"repeated_foreign_enum,omitempty"`
	RepeatedImportenum        []ImportEnum                           `protobuf:"varint,53,rep,name=repeated_importenum,json=repeatedImportenum,enum=goproto.grpc.test.ImportEnum" json:"repeated_importenum,omitempty"`
	MapInt32Int32             map[int32]int32                        `protobuf:"bytes,56,rep,name=map_int32_int32,json=mapInt32Int32" json:"map_int32_int32,omitempty" protobuf_key:"varint,1,opt,name=certs" protobuf_val:"varint,2,opt,name=value"`
	MapInt64Int64             map[int64]int64                        `protobuf:"bytes,57,rep,name=map_int64_int64,json=mapInt64Int64" json:"map_int64_int64,omitempty" protobuf_key:"varint,1,opt,name=certs" protobuf_val:"varint,2,opt,name=value"`
	MapUint32Uint32           map[uint32]uint32                      `protobuf:"bytes,58,rep,name=map_uint32_uint32,json=mapUint32Uint32" json:"map_uint32_uint32,omitempty" protobuf_key:"varint,1,opt,name=certs" protobuf_val:"varint,2,opt,name=value"`
	MapUint64Uint64           map[uint64]uint64                      `protobuf:"bytes,59,rep,name=map_uint64_uint64,json=mapUint64Uint64" json:"map_uint64_uint64,omitempty" protobuf_key:"varint,1,opt,name=certs" protobuf_val:"varint,2,opt,name=value"`
	MapSint32Sint32           map[int32]int32                        `protobuf:"bytes,60,rep,name=map_sint32_sint32,json=mapSint32Sint32" json:"map_sint32_sint32,omitempty" protobuf_key:"zigzag32,1,opt,name=certs" protobuf_val:"zigzag32,2,opt,name=value"`
	MapSint64Sint64           map[int64]int64                        `protobuf:"bytes,61,rep,name=map_sint64_sint64,json=mapSint64Sint64" json:"map_sint64_sint64,omitempty" protobuf_key:"zigzag64,1,opt,name=certs" protobuf_val:"zigzag64,2,opt,name=value"`
	MapFixed32Fixed32         map[uint32]uint32                      `protobuf:"bytes,62,rep,name=map_fixed32_fixed32,json=mapFixed32Fixed32" json:"map_fixed32_fixed32,omitempty" protobuf_key:"fixed32,1,opt,name=certs" protobuf_val:"fixed32,2,opt,name=value"`
	MapFixed64Fixed64         map[uint64]uint64                      `protobuf:"bytes,63,rep,name=map_fixed64_fixed64,json=mapFixed64Fixed64" json:"map_fixed64_fixed64,omitempty" protobuf_key:"fixed64,1,opt,name=certs" protobuf_val:"fixed64,2,opt,name=value"`
	MapSfixed32Sfixed32       map[int32]int32                        `protobuf:"bytes,64,rep,name=map_sfixed32_sfixed32,json=mapSfixed32Sfixed32" json:"map_sfixed32_sfixed32,omitempty" protobuf_key:"fixed32,1,opt,name=certs" protobuf_val:"fixed32,2,opt,name=value"`
	MapSfixed64Sfixed64       map[int64]int64                        `protobuf:"bytes,65,rep,name=map_sfixed64_sfixed64,json=mapSfixed64Sfixed64" json:"map_sfixed64_sfixed64,omitempty" protobuf_key:"fixed64,1,opt,name=certs" protobuf_val:"fixed64,2,opt,name=value"`
	MapInt32Float             map[int32]float32                      `protobuf:"bytes,66,rep,name=map_int32_float,json=mapInt32Float" json:"map_int32_float,omitempty" protobuf_key:"varint,1,opt,name=certs" protobuf_val:"fixed32,2,opt,name=value"`
	MapInt32Double            map[int32]float64                      `protobuf:"bytes,67,rep,name=map_int32_double,json=mapInt32Double" json:"map_int32_double,omitempty" protobuf_key:"varint,1,opt,name=certs" protobuf_val:"fixed64,2,opt,name=value"`
	MapBoolBool               map[bool]bool                          `protobuf:"bytes,68,rep,name=map_bool_bool,json=mapBoolBool" json:"map_bool_bool,omitempty" protobuf_key:"varint,1,opt,name=certs" protobuf_val:"varint,2,opt,name=value"`
	MapStringString           map[string]string                      `protobuf:"bytes,69,rep,name=map_string_string,json=mapStringString" json:"map_string_string,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"bytes,2,opt,name=value"`
	MapStringBytes            map[string][]byte                      `protobuf:"bytes,70,rep,name=map_string_bytes,json=mapStringBytes" json:"map_string_bytes,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"bytes,2,opt,name=value"`
	MapStringNestedMessage    map[string]*TestAllTypes_NestedMessage `protobuf:"bytes,71,rep,name=map_string_nested_message,json=mapStringNestedMessage" json:"map_string_nested_message,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"bytes,2,opt,name=value"`
	MapStringNestedEnum       map[string]TestAllTypes_NestedEnum     `protobuf:"bytes,73,rep,name=map_string_nested_enum,json=mapStringNestedEnum" json:"map_string_nested_enum,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"varint,2,opt,name=value,enum=goproto.grpc.test.TestAllTypes_NestedEnum"`
	...
	DefaultNestedEnum  *TestAllTypes_NestedEnum `protobuf:"varint,96,opt,name=default_nested_enum,json=defaultNestedEnum,enum=goproto.grpc.test.TestAllTypes_NestedEnum,def=1" json:"default_nested_enum,omitempty"`
	DefaultForeignEnum *ForeignEnum             `protobuf:"varint,97,opt,name=default_foreign_enum,json=defaultForeignEnum,enum=goproto.grpc.test.ForeignEnum,def=5" json:"default_foreign_enum,omitempty"`
...
type TestAllTypes_OneofEnum struct {
	OneofEnum TestAllTypes_NestedEnum `protobuf:"varint,119,opt,name=oneof_enum,json=oneofEnum,enum=goproto.grpc.test.TestAllTypes_NestedEnum,oneof"`
}
...
type TestRequiredForeign struct {
	...
	MapMessage      map[int32]*TestRequired `protobuf:"bytes,3,rep,name=map_message,json=mapMessage" json:"map_message,omitempty" protobuf_key:"varint,1,opt,name=certs" protobuf_val:"bytes,2,opt,name=value"`
	// Types that are assignable to OneofField:
	//
...
type TestWeak struct {
	...
	XXX_weak_WeakMessage1 struct{} `protobuf:"bytes,1,opt,name=weak_message1,json=weakMessage1,weak=goproto.grpc.test.weak.WeakImportMessage1" json:"weak_message1,omitempty"`
	XXX_weak_WeakMessage2 struct{} `protobuf:"bytes,2,opt,name=weak_message2,json=weakMessage2,weak=goproto.grpc.test.weak.WeakImportMessage2" json:"weak_message2,omitempty"`
}
...
func (x *TestWeak) GetWeakMessage1() proto.Message {
	...
	return protoimpl.X.GetWeak(w, 1, "goproto.grpc.test.weak.WeakImportMessage1")
}
...
func (x *TestWeak) GetWeakMessage2() proto.Message {
	...
	return protoimpl.X.GetWeak(w, 2, "goproto.grpc.test.weak.WeakImportMessage2")
}
...
func (x *TestWeak) SetWeakMessage1(v proto.Message) {
	...
	protoimpl.X.SetWeak(w, 1, "goproto.grpc.test.weak.WeakImportMessage1", v)
}
...
func (x *TestWeak) SetWeakMessage2(v proto.Message) {
	...
	protoimpl.X.SetWeak(w, 2, "goproto.grpc.test.weak.WeakImportMessage2", v)
}
...
type TestPackedTypes struct {
	...
	PackedEnum     []ForeignEnum `protobuf:"varint,103,rep,packed,name=packed_enum,json=packedEnum,enum=goproto.grpc.test.ForeignEnum" json:"packed_enum,omitempty"`
}
...
type TestUnpackedTypes struct {
	...
	UnpackedEnum     []ForeignEnum `protobuf:"varint,103,rep,name=unpacked_enum,json=unpackedEnum,enum=goproto.grpc.test.ForeignEnum" json:"unpacked_enum,omitempty"`
}
...
type RemoteDefault struct {
	...
	Default     *enums.Enum `protobuf:"varint,1,opt,name=default,enum=goproto.grpc.enums.Enum" json:"default,omitempty"`
	Zero        *enums.Enum `protobuf:"varint,2,opt,name=zero,enum=goproto.grpc.enums.Enum,def=0" json:"zero,omitempty"`
	One         *enums.Enum `protobuf:"varint,3,opt,name=one,enum=goproto.grpc.enums.Enum,def=1" json:"one,omitempty"`
	Elevent     *enums.Enum `protobuf:"varint,4,opt,name=elevent,enum=goproto.grpc.enums.Enum,def=11" json:"elevent,omitempty"`
	Seventeen   *enums.Enum `protobuf:"varint,5,opt,name=seventeen,enum=goproto.grpc.enums.Enum,def=17" json:"seventeen,omitempty"`
	Thirtyseven *enums.Enum `protobuf:"varint,6,opt,name=thirtyseven,enum=goproto.grpc.enums.Enum,def=37" json:"thirtyseven,omitempty"`
	Sixtyseven  *enums.Enum `protobuf:"varint,7,opt,name=sixtyseven,enum=goproto.grpc.enums.Enum,def=67" json:"sixtyseven,omitempty"`
	Negative    *enums.Enum `protobuf:"varint,8,opt,name=negative,enum=goproto.grpc.enums.Enum,def=-1" json:"negative,omitempty"`
}
...
var file_internal_testprotos_test_test_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Field:         1,
		Name:          "goproto.grpc.test.optional_int32",
		Tag:           "varint,1,opt,name=optional_int32",
		Filename:      "internal/testprotos/test/test.grpc",
	},
	{
		ExtendedType:  (*TestAllExtensions)(nil),
		ExtensionType: (*int64)(nil),
		Field:         2,
		Name:          "goproto.grpc.test.optional_int64",
	...
	},
	{
		...
		Field:         3,
		Name:          "goproto.grpc.test.optional_uint32",
	...
	},
	{
		...
		Field:         4,
		Name:          "goproto.grpc.test.optional_uint64",
	...
	},
	{
		...
		ExtensionType: (*int32)(nil),
		Field:         5,
		Name:          "goproto.grpc.test.optional_sint32",
	...
	},
	{
		...
		ExtensionType: (*int64)(nil),
		Field:         6,
		Name:          "goproto.grpc.test.optional_sint64",
	...
	},
	{
		...
		ExtensionType: (*uint32)(nil),
		Field:         7,
		Name:          "goproto.grpc.test.optional_fixed32",
	...
	},
	{
		...
		ExtensionType: (*uint64)(nil),
		Field:         8,
		Name:          "goproto.grpc.test.optional_fixed64",
	...
	},
	{
		...
		ExtensionType: (*int32)(nil),
		Field:         9,
		Name:          "goproto.grpc.test.optional_sfixed32",
	...
	},
	{
		...
		ExtensionType: (*int64)(nil),
		Field:         10,
		Name:          "goproto.grpc.test.optional_sfixed64",
	...
	},
	{
		...
		Field:         11,
		Name:          "goproto.grpc.test.optional_float",
	...
	},
	{
		...
		Field:         12,
		Name:          "goproto.grpc.test.optional_double",
	...
	},
	{
		...
		Field:         13,
		Name:          "goproto.grpc.test.optional_bool",
	...
	},
	{
		...
		Field:         14,
		Name:          "goproto.grpc.test.optional_string",
	...
	},
	{
		...
		Field:         15,
		Name:          "goproto.grpc.test.optional_bytes",
	...
	},
	{
		...
		Field:         16,
		Name:          "goproto.grpc.test.optionalgroup",
	...
	},
	{
		...
		Field:         18,
		Name:          "goproto.grpc.test.optional_nested_message",
	...
	},
	{
		...
		Field:         21,
		Name:          "goproto.grpc.test.optional_nested_enum",
		Tag:           "varint,21,opt,name=optional_nested_enum,enum=goproto.grpc.test.TestAllTypes_NestedEnum",
		Filename:      "internal/testprotos/test/test.grpc",
	},
	{
		ExtendedType:  (*TestAllExtensions)(nil),
		ExtensionType: ([]int32)(nil),
		Field:         31,
		Name:          "goproto.grpc.test.repeated_int32",
	...
	},
	{
		...
		ExtensionType: ([]int64)(nil),
		Field:         32,
		Name:          "goproto.grpc.test.repeated_int64",
	...
	},
	{
		...
		ExtensionType: ([]uint32)(nil),
		Field:         33,
		Name:          "goproto.grpc.test.repeated_uint32",
	...
	},
	{
		...
		ExtensionType: ([]uint64)(nil),
		Field:         34,
		Name:          "goproto.grpc.test.repeated_uint64",
	...
	},
	{
		...
		ExtensionType: ([]int32)(nil),
		Field:         35,
		Name:          "goproto.grpc.test.repeated_sint32",
	...
	},
	{
		...
		ExtensionType: ([]int64)(nil),
		Field:         36,
		Name:          "goproto.grpc.test.repeated_sint64",
	...
	},
	{
		...
		ExtensionType: ([]uint32)(nil),
		Field:         37,
		Name:          "goproto.grpc.test.repeated_fixed32",
	...
	},
	{
		...
		ExtensionType: ([]uint64)(nil),
		Field:         38,
		Name:          "goproto.grpc.test.repeated_fixed64",
	...
	},
	{
		...
		ExtensionType: ([]int32)(nil),
		Field:         39,
		Name:          "goproto.grpc.test.repeated_sfixed32",
	...
	},
	{
		...
		ExtensionType: ([]int64)(nil),
		Field:         40,
		Name:          "goproto.grpc.test.repeated_sfixed64",
	...
	},
	{
		...
		ExtensionType: ([]float32)(nil),
		Field:         41,
		Name:          "goproto.grpc.test.repeated_float",
	...
	},
	{
		...
		ExtensionType: ([]float64)(nil),
		Field:         42,
		Name:          "goproto.grpc.test.repeated_double",
	...
	},
	{
		...
		ExtensionType: ([]bool)(nil),
		Field:         43,
		Name:          "goproto.grpc.test.repeated_bool",
	...
	},
	{
		...
		ExtensionType: ([]string)(nil),
		Field:         44,
		Name:          "goproto.grpc.test.repeated_string",
	...
	},
	{
		...
		ExtensionType: ([][]byte)(nil),
		Field:         45,
		Name:          "goproto.grpc.test.repeated_bytes",
	...
	},
	{
		...
		Field:         46,
		Name:          "goproto.grpc.test.repeatedgroup",
	...
	},
	{
		...
		ExtensionType: ([]*TestAllExtensions_NestedMessage)(nil),
		Field:         48,
		Name:          "goproto.grpc.test.repeated_nested_message",
	...
	},
	{
		...
		ExtensionType: ([]TestAllTypes_NestedEnum)(nil),
		Field:         51,
		Name:          "goproto.grpc.test.repeated_nested_enum",
		Tag:           "varint,51,rep,name=repeated_nested_enum,enum=goproto.grpc.test.TestAllTypes_NestedEnum",
		Filename:      "internal/testprotos/test/test.grpc",
	},
	{
		ExtendedType:  (*TestAllExtensions)(nil),
		ExtensionType: (*int32)(nil),
		Field:         81,
		Name:          "goproto.grpc.test.default_int32",
	...
	},
	{
		...
		ExtensionType: (*int64)(nil),
		Field:         82,
		Name:          "goproto.grpc.test.default_int64",
	...
	},
	{
		...
		ExtensionType: (*uint32)(nil),
		Field:         83,
		Name:          "goproto.grpc.test.default_uint32",
	...
	},
	{
		...
		ExtensionType: (*uint64)(nil),
		Field:         84,
		Name:          "goproto.grpc.test.default_uint64",
	...
	},
	{
		...
		ExtensionType: (*int32)(nil),
		Field:         85,
		Name:          "goproto.grpc.test.default_sint32",
	...
	},
	{
		...
		ExtensionType: (*int64)(nil),
		Field:         86,
		Name:          "goproto.grpc.test.default_sint64",
	...
	},
	{
		...
		ExtensionType: (*uint32)(nil),
		Field:         87,
		Name:          "goproto.grpc.test.default_fixed32",
	...
	},
	{
		...
		ExtensionType: (*uint64)(nil),
		Field:         88,
		Name:          "goproto.grpc.test.default_fixed64",
	...
	},
	{
		...
		ExtensionType: (*int32)(nil),
		Field:         89,
		Name:          "goproto.grpc.test.default_sfixed32",
	...
	},
	{
		...
		ExtensionType: (*int64)(nil),
		Field:         80,
		Name:          "goproto.grpc.test.default_sfixed64",
	...
	},
	{
		...
		ExtensionType: (*float32)(nil),
		Field:         91,
		Name:          "goproto.grpc.test.default_float",
	...
	},
	{
		...
		ExtensionType: (*float64)(nil),
		Field:         92,
		Name:          "goproto.grpc.test.default_double",
	...
	},
	{
		...
		ExtensionType: (*bool)(nil),
		Field:         93,
		Name:          "goproto.grpc.test.default_bool",
	...
	},
	{
		...
		ExtensionType: (*string)(nil),
		Field:         94,
		Name:          "goproto.grpc.test.default_string",
	...
	},
	{
		...
		ExtensionType: ([]byte)(nil),
		Field:         95,
		Name:          "goproto.grpc.test.default_bytes",
	...
	},
	{
		...
		ExtensionType: ([]int32)(nil),
		Field:         90,
		Name:          "goproto.grpc.test.packed_int32",
	...
	},
	{
		...
		ExtensionType: ([]int64)(nil),
		Field:         91,
		Name:          "goproto.grpc.test.packed_int64",
	...
	},
	{
		...
		ExtensionType: ([]uint32)(nil),
		Field:         92,
		Name:          "goproto.grpc.test.packed_uint32",
	...
	},
	{
		...
		ExtensionType: ([]uint64)(nil),
		Field:         93,
		Name:          "goproto.grpc.test.packed_uint64",
	...
	},
	{
		...
		ExtensionType: ([]int32)(nil),
		Field:         94,
		Name:          "goproto.grpc.test.packed_sint32",
	...
	},
	{
		...
		ExtensionType: ([]int64)(nil),
		Field:         95,
		Name:          "goproto.grpc.test.packed_sint64",
	...
	},
	{
		...
		ExtensionType: ([]uint32)(nil),
		Field:         96,
		Name:          "goproto.grpc.test.packed_fixed32",
	...
	},
	{
		...
		ExtensionType: ([]uint64)(nil),
		Field:         97,
		Name:          "goproto.grpc.test.packed_fixed64",
	...
	},
	{
		...
		ExtensionType: ([]int32)(nil),
		Field:         98,
		Name:          "goproto.grpc.test.packed_sfixed32",
	...
	},
	{
		...
		ExtensionType: ([]int64)(nil),
		Field:         99,
		Name:          "goproto.grpc.test.packed_sfixed64",
	...
	},
	{
		...
		ExtensionType: ([]float32)(nil),
		Field:         100,
		Name:          "goproto.grpc.test.packed_float",
	...
	},
	{
		...
		ExtensionType: ([]float64)(nil),
		Field:         101,
		Name:          "goproto.grpc.test.packed_double",
	...
	},
	{
		...
		ExtensionType: ([]bool)(nil),
		Field:         102,
		Name:          "goproto.grpc.test.packed_bool",
	...
	},
	{
		...
		Field:         103,
		Name:          "goproto.grpc.test.packed_enum",
		Tag:           "varint,103,rep,packed,name=packed_enum,enum=goproto.grpc.test.ForeignEnum",
		Filename:      "internal/testprotos/test/test.grpc",
	},
	{
		...
		ExtensionType: ([]int32)(nil),
		Field:         90,
		Name:          "goproto.grpc.test.unpacked_int32",
	...
	},
	{
		...
		ExtensionType: ([]int64)(nil),
		Field:         91,
		Name:          "goproto.grpc.test.unpacked_int64",
	...
	},
	{
		...
		ExtensionType: ([]uint32)(nil),
		Field:         92,
		Name:          "goproto.grpc.test.unpacked_uint32",
	...
	},
	{
		...
		ExtensionType: ([]uint64)(nil),
		Field:         93,
		Name:          "goproto.grpc.test.unpacked_uint64",
	...
	},
	{
		...
		ExtensionType: ([]int32)(nil),
		Field:         94,
		Name:          "goproto.grpc.test.unpacked_sint32",
	...
	},
	{
		...
		ExtensionType: ([]int64)(nil),
		Field:         95,
		Name:          "goproto.grpc.test.unpacked_sint64",
	...
	},
	{
		...
		ExtensionType: ([]uint32)(nil),
		Field:         96,
		Name:          "goproto.grpc.test.unpacked_fixed32",
	...
	},
	{
		...
		ExtensionType: ([]uint64)(nil),
		Field:         97,
		Name:          "goproto.grpc.test.unpacked_fixed64",
	...
	},
	{
		...
		ExtensionType: ([]int32)(nil),
		Field:         98,
		Name:          "goproto.grpc.test.unpacked_sfixed32",
	...
	},
	{
		...
		ExtensionType: ([]int64)(nil),
		Field:         99,
		Name:          "goproto.grpc.test.unpacked_sfixed64",
	...
	},
	{
		...
		ExtensionType: ([]float32)(nil),
		Field:         100,
		Name:          "goproto.grpc.test.unpacked_float",
	...
	},
	{
		...
		ExtensionType: ([]float64)(nil),
		Field:         101,
		Name:          "goproto.grpc.test.unpacked_double",
	...
	},
	{
		...
		ExtensionType: ([]bool)(nil),
		Field:         102,
		Name:          "goproto.grpc.test.unpacked_bool",
	...
	},
	{
		...
		ExtensionType: ([]ForeignEnum)(nil),
		Field:         103,
		Name:          "goproto.grpc.test.unpacked_enum",
		Tag:           "varint,103,rep,name=unpacked_enum,enum=goproto.grpc.test.ForeignEnum",
		Filename:      "internal/testprotos/test/test.grpc",
	},
	{
		ExtendedType:  (*TestAllExtensions)(nil),
		ExtensionType: (*string)(nil),
		Field:         1003,
		Name:          "goproto.grpc.test.TestNestedExtension.nested_string_extension",
	...
	},
	{
		...
		Field:         1000,
		Name:          "goproto.grpc.test.TestRequired.single",
	...
	},
	{
		...
		ExtensionType: ([]*TestRequired)(nil),
		Field:         1001,
		Name:          "goproto.grpc.test.TestRequired.multi",
...
var (
	...
	// optional goproto.grpc.test.OptionalGroup optionalgroup = 16;
	E_Optionalgroup = &file_internal_testprotos_test_test_proto_extTypes[15]
	// optional goproto.grpc.test.TestAllExtensions.NestedMessage optional_nested_message = 18;
	E_OptionalNestedMessage = &file_internal_testprotos_test_test_proto_extTypes[16]
	// optional goproto.grpc.test.TestAllTypes.NestedEnum optional_nested_enum = 21;
	...
	// repeated goproto.grpc.test.RepeatedGroup repeatedgroup = 46;
	E_Repeatedgroup = &file_internal_testprotos_test_test_proto_extTypes[33]
	// repeated goproto.grpc.test.TestAllExtensions.NestedMessage repeated_nested_message = 48;
	E_RepeatedNestedMessage = &file_internal_testprotos_test_test_proto_extTypes[34]
	// repeated goproto.grpc.test.TestAllTypes.NestedEnum repeated_nested_enum = 51;
	...
	// optional goproto.grpc.test.TestRequired single = 1000;
	E_TestRequired_Single = &file_internal_testprotos_test_test_proto_extTypes[80]
	// repeated goproto.grpc.test.TestRequired multi = 1001;
...
var (
	...
	// repeated goproto.grpc.test.ForeignEnum packed_enum = 103;
...
var (
	...
	// repeated goproto.grpc.test.ForeignEnum unpacked_enum = 103;
...
var file_internal_testprotos_test_test_proto_goTypes = []any{
	(ForeignEnum)(0),                          // 0: goproto.grpc.test.ForeignEnum
	(TestReservedEnumFields)(0),               // 1: goproto.grpc.test.TestReservedEnumFields
	(TestAllTypes_NestedEnum)(0),              // 2: goproto.grpc.test.TestAllTypes.NestedEnum
	(TestDeprecatedMessage_DeprecatedEnum)(0), // 3: goproto.grpc.test.TestDeprecatedMessage.DeprecatedEnum
	(*TestAllTypes)(nil),                      // 4: goproto.grpc.test.TestAllTypes
	(*TestManyMessageFieldsMessage)(nil),      // 5: goproto.grpc.test.TestManyMessageFieldsMessage
	(*TestDeprecatedMessage)(nil),             // 6: goproto.grpc.test.TestDeprecatedMessage
	(*TestOneofWithRequired)(nil),             // 7: goproto.grpc.test.TestOneofWithRequired
	(*ForeignMessage)(nil),                    // 8: goproto.grpc.test.ForeignMessage
	(*TestReservedFields)(nil),                // 9: goproto.grpc.test.TestReservedFields
	(*TestAllExtensions)(nil),                 // 10: goproto.grpc.test.TestAllExtensions
	(*OptionalGroup)(nil),                     // 11: goproto.grpc.test.OptionalGroup
	(*RepeatedGroup)(nil),                     // 12: goproto.grpc.test.RepeatedGroup
	(*TestNestedExtension)(nil),               // 13: goproto.grpc.test.TestNestedExtension
	(*TestRequired)(nil),                      // 14: goproto.grpc.test.TestRequired
	(*TestRequiredForeign)(nil),               // 15: goproto.grpc.test.TestRequiredForeign
	(*TestRequiredGroupFields)(nil),           // 16: goproto.grpc.test.TestRequiredGroupFields
	(*TestWeak)(nil),                          // 17: goproto.grpc.test.TestWeak
	(*TestPackedTypes)(nil),                   // 18: goproto.grpc.test.TestPackedTypes
	(*TestUnpackedTypes)(nil),                 // 19: goproto.grpc.test.TestUnpackedTypes
	(*TestPackedExtensions)(nil),              // 20: goproto.grpc.test.TestPackedExtensions
	(*TestUnpackedExtensions)(nil),            // 21: goproto.grpc.test.TestUnpackedExtensions
	(*FooRequest)(nil),                        // 22: goproto.grpc.test.FooRequest
	(*FooResponse)(nil),                       // 23: goproto.grpc.test.FooResponse
	(*WeirdDefault)(nil),                      // 24: goproto.grpc.test.WeirdDefault
	(*RemoteDefault)(nil),                     // 25: goproto.grpc.test.RemoteDefault
	(*TestAllTypes_NestedMessage)(nil),        // 26: goproto.grpc.test.TestAllTypes.NestedMessage
	(*TestAllTypes_OptionalGroup)(nil),        // 27: goproto.grpc.test.TestAllTypes.OptionalGroup
	(*TestAllTypes_RepeatedGroup)(nil),        // 28: goproto.grpc.test.TestAllTypes.RepeatedGroup
	nil,                                       // 29: goproto.grpc.test.TestAllTypes.MapInt32Int32Entry
	nil,                                       // 30: goproto.grpc.test.TestAllTypes.MapInt64Int64Entry
	nil,                                       // 31: goproto.grpc.test.TestAllTypes.MapUint32Uint32Entry
	nil,                                       // 32: goproto.grpc.test.TestAllTypes.MapUint64Uint64Entry
	nil,                                       // 33: goproto.grpc.test.TestAllTypes.MapSint32Sint32Entry
	nil,                                       // 34: goproto.grpc.test.TestAllTypes.MapSint64Sint64Entry
	nil,                                       // 35: goproto.grpc.test.TestAllTypes.MapFixed32Fixed32Entry
	nil,                                       // 36: goproto.grpc.test.TestAllTypes.MapFixed64Fixed64Entry
	nil,                                       // 37: goproto.grpc.test.TestAllTypes.MapSfixed32Sfixed32Entry
	nil,                                       // 38: goproto.grpc.test.TestAllTypes.MapSfixed64Sfixed64Entry
	nil,                                       // 39: goproto.grpc.test.TestAllTypes.MapInt32FloatEntry
	nil,                                       // 40: goproto.grpc.test.TestAllTypes.MapInt32DoubleEntry
	nil,                                       // 41: goproto.grpc.test.TestAllTypes.MapBoolBoolEntry
	nil,                                       // 42: goproto.grpc.test.TestAllTypes.MapStringStringEntry
	nil,                                       // 43: goproto.grpc.test.TestAllTypes.MapStringBytesEntry
	nil,                                       // 44: goproto.grpc.test.TestAllTypes.MapStringNestedMessageEntry
	nil,                                       // 45: goproto.grpc.test.TestAllTypes.MapStringNestedEnumEntry
	(*TestAllTypes_OneofGroup)(nil),           // 46: goproto.grpc.test.TestAllTypes.OneofGroup
	(*TestAllExtensions_NestedMessage)(nil),   // 47: goproto.grpc.test.TestAllExtensions.NestedMessage
	nil,                                       // 48: goproto.grpc.test.TestRequiredForeign.MapMessageEntry
	(*TestRequiredGroupFields_OptionalGroup)(nil), // 49: goproto.grpc.test.TestRequiredGroupFields.OptionalGroup
	(*TestRequiredGroupFields_RepeatedGroup)(nil), // 50: goproto.grpc.test.TestRequiredGroupFields.RepeatedGroup
	(*ImportMessage)(nil),                         // 51: goproto.grpc.test.ImportMessage
	(ImportEnum)(0),                               // 52: goproto.grpc.test.ImportEnum
	(*required.Message)(nil),                      // 53: goproto.grpc.testrequired.Message
	(enums.Enum)(0),                               // 54: goproto.grpc.enums.Enum
}
var file_internal_testprotos_test_test_proto_depIdxs = []int32{
	27,  // 0: goproto.grpc.test.TestAllTypes.optionalgroup:type_name -> goproto.grpc.test.TestAllTypes.OptionalGroup
	26,  // 1: goproto.grpc.test.TestAllTypes.optional_nested_message:type_name -> goproto.grpc.test.TestAllTypes.NestedMessage
	8,   // 2: goproto.grpc.test.TestAllTypes.optional_foreign_message:type_name -> goproto.grpc.test.ForeignMessage
	51,  // 3: goproto.grpc.test.TestAllTypes.optional_import_message:type_name -> goproto.grpc.test.ImportMessage
	2,   // 4: goproto.grpc.test.TestAllTypes.optional_nested_enum:type_name -> goproto.grpc.test.TestAllTypes.NestedEnum
	0,   // 5: goproto.grpc.test.TestAllTypes.optional_foreign_enum:type_name -> goproto.grpc.test.ForeignEnum
	52,  // 6: goproto.grpc.test.TestAllTypes.optional_import_enum:type_name -> goproto.grpc.test.ImportEnum
	26,  // 7: goproto.grpc.test.TestAllTypes.optional_lazy_nested_message:type_name -> goproto.grpc.test.TestAllTypes.NestedMessage
	28,  // 8: goproto.grpc.test.TestAllTypes.repeatedgroup:type_name -> goproto.grpc.test.TestAllTypes.RepeatedGroup
	26,  // 9: goproto.grpc.test.TestAllTypes.repeated_nested_message:type_name -> goproto.grpc.test.TestAllTypes.NestedMessage
	8,   // 10: goproto.grpc.test.TestAllTypes.repeated_foreign_message:type_name -> goproto.grpc.test.ForeignMessage
	51,  // 11: goproto.grpc.test.TestAllTypes.repeated_importmessage:type_name -> goproto.grpc.test.ImportMessage
	2,   // 12: goproto.grpc.test.TestAllTypes.repeated_nested_enum:type_name -> goproto.grpc.test.TestAllTypes.NestedEnum
	0,   // 13: goproto.grpc.test.TestAllTypes.repeated_foreign_enum:type_name -> goproto.grpc.test.ForeignEnum
	52,  // 14: goproto.grpc.test.TestAllTypes.repeated_importenum:type_name -> goproto.grpc.test.ImportEnum
	29,  // 15: goproto.grpc.test.TestAllTypes.map_int32_int32:type_name -> goproto.grpc.test.TestAllTypes.MapInt32Int32Entry
	30,  // 16: goproto.grpc.test.TestAllTypes.map_int64_int64:type_name -> goproto.grpc.test.TestAllTypes.MapInt64Int64Entry
	31,  // 17: goproto.grpc.test.TestAllTypes.map_uint32_uint32:type_name -> goproto.grpc.test.TestAllTypes.MapUint32Uint32Entry
	32,  // 18: goproto.grpc.test.TestAllTypes.map_uint64_uint64:type_name -> goproto.grpc.test.TestAllTypes.MapUint64Uint64Entry
	33,  // 19: goproto.grpc.test.TestAllTypes.map_sint32_sint32:type_name -> goproto.grpc.test.TestAllTypes.MapSint32Sint32Entry
	34,  // 20: goproto.grpc.test.TestAllTypes.map_sint64_sint64:type_name -> goproto.grpc.test.TestAllTypes.MapSint64Sint64Entry
	35,  // 21: goproto.grpc.test.TestAllTypes.map_fixed32_fixed32:type_name -> goproto.grpc.test.TestAllTypes.MapFixed32Fixed32Entry
	36,  // 22: goproto.grpc.test.TestAllTypes.map_fixed64_fixed64:type_name -> goproto.grpc.test.TestAllTypes.MapFixed64Fixed64Entry
	37,  // 23: goproto.grpc.test.TestAllTypes.map_sfixed32_sfixed32:type_name -> goproto.grpc.test.TestAllTypes.MapSfixed32Sfixed32Entry
	38,  // 24: goproto.grpc.test.TestAllTypes.map_sfixed64_sfixed64:type_name -> goproto.grpc.test.TestAllTypes.MapSfixed64Sfixed64Entry
	39,  // 25: goproto.grpc.test.TestAllTypes.map_int32_float:type_name -> goproto.grpc.test.TestAllTypes.MapInt32FloatEntry
	40,  // 26: goproto.grpc.test.TestAllTypes.map_int32_double:type_name -> goproto.grpc.test.TestAllTypes.MapInt32DoubleEntry
	41,  // 27: goproto.grpc.test.TestAllTypes.map_bool_bool:type_name -> goproto.grpc.test.TestAllTypes.MapBoolBoolEntry
	42,  // 28: goproto.grpc.test.TestAllTypes.map_string_string:type_name -> goproto.grpc.test.TestAllTypes.MapStringStringEntry
	43,  // 29: goproto.grpc.test.TestAllTypes.map_string_bytes:type_name -> goproto.grpc.test.TestAllTypes.MapStringBytesEntry
	44,  // 30: goproto.grpc.test.TestAllTypes.map_string_nested_message:type_name -> goproto.grpc.test.TestAllTypes.MapStringNestedMessageEntry
	45,  // 31: goproto.grpc.test.TestAllTypes.map_string_nested_enum:type_name -> goproto.grpc.test.TestAllTypes.MapStringNestedEnumEntry
	2,   // 32: goproto.grpc.test.TestAllTypes.default_nested_enum:type_name -> goproto.grpc.test.TestAllTypes.NestedEnum
	0,   // 33: goproto.grpc.test.TestAllTypes.default_foreign_enum:type_name -> goproto.grpc.test.ForeignEnum
	26,  // 34: goproto.grpc.test.TestAllTypes.oneof_nested_message:type_name -> goproto.grpc.test.TestAllTypes.NestedMessage
	2,   // 35: goproto.grpc.test.TestAllTypes.oneof_enum:type_name -> goproto.grpc.test.TestAllTypes.NestedEnum
	46,  // 36: goproto.grpc.test.TestAllTypes.oneofgroup:type_name -> goproto.grpc.test.TestAllTypes.OneofGroup
	4,   // 37: goproto.grpc.test.TestManyMessageFieldsMessage.f1:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 38: goproto.grpc.test.TestManyMessageFieldsMessage.f2:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 39: goproto.grpc.test.TestManyMessageFieldsMessage.f3:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 40: goproto.grpc.test.TestManyMessageFieldsMessage.f4:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 41: goproto.grpc.test.TestManyMessageFieldsMessage.f5:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 42: goproto.grpc.test.TestManyMessageFieldsMessage.f6:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 43: goproto.grpc.test.TestManyMessageFieldsMessage.f7:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 44: goproto.grpc.test.TestManyMessageFieldsMessage.f8:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 45: goproto.grpc.test.TestManyMessageFieldsMessage.f9:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 46: goproto.grpc.test.TestManyMessageFieldsMessage.f10:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 47: goproto.grpc.test.TestManyMessageFieldsMessage.f11:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 48: goproto.grpc.test.TestManyMessageFieldsMessage.f12:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 49: goproto.grpc.test.TestManyMessageFieldsMessage.f13:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 50: goproto.grpc.test.TestManyMessageFieldsMessage.f14:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 51: goproto.grpc.test.TestManyMessageFieldsMessage.f15:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 52: goproto.grpc.test.TestManyMessageFieldsMessage.f16:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 53: goproto.grpc.test.TestManyMessageFieldsMessage.f17:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 54: goproto.grpc.test.TestManyMessageFieldsMessage.f18:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 55: goproto.grpc.test.TestManyMessageFieldsMessage.f19:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 56: goproto.grpc.test.TestManyMessageFieldsMessage.f20:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 57: goproto.grpc.test.TestManyMessageFieldsMessage.f21:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 58: goproto.grpc.test.TestManyMessageFieldsMessage.f22:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 59: goproto.grpc.test.TestManyMessageFieldsMessage.f23:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 60: goproto.grpc.test.TestManyMessageFieldsMessage.f24:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 61: goproto.grpc.test.TestManyMessageFieldsMessage.f25:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 62: goproto.grpc.test.TestManyMessageFieldsMessage.f26:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 63: goproto.grpc.test.TestManyMessageFieldsMessage.f27:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 64: goproto.grpc.test.TestManyMessageFieldsMessage.f28:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 65: goproto.grpc.test.TestManyMessageFieldsMessage.f29:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 66: goproto.grpc.test.TestManyMessageFieldsMessage.f30:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 67: goproto.grpc.test.TestManyMessageFieldsMessage.f31:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 68: goproto.grpc.test.TestManyMessageFieldsMessage.f32:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 69: goproto.grpc.test.TestManyMessageFieldsMessage.f33:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 70: goproto.grpc.test.TestManyMessageFieldsMessage.f34:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 71: goproto.grpc.test.TestManyMessageFieldsMessage.f35:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 72: goproto.grpc.test.TestManyMessageFieldsMessage.f36:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 73: goproto.grpc.test.TestManyMessageFieldsMessage.f37:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 74: goproto.grpc.test.TestManyMessageFieldsMessage.f38:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 75: goproto.grpc.test.TestManyMessageFieldsMessage.f39:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 76: goproto.grpc.test.TestManyMessageFieldsMessage.f40:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 77: goproto.grpc.test.TestManyMessageFieldsMessage.f41:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 78: goproto.grpc.test.TestManyMessageFieldsMessage.f42:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 79: goproto.grpc.test.TestManyMessageFieldsMessage.f43:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 80: goproto.grpc.test.TestManyMessageFieldsMessage.f44:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 81: goproto.grpc.test.TestManyMessageFieldsMessage.f45:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 82: goproto.grpc.test.TestManyMessageFieldsMessage.f46:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 83: goproto.grpc.test.TestManyMessageFieldsMessage.f47:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 84: goproto.grpc.test.TestManyMessageFieldsMessage.f48:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 85: goproto.grpc.test.TestManyMessageFieldsMessage.f49:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 86: goproto.grpc.test.TestManyMessageFieldsMessage.f50:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 87: goproto.grpc.test.TestManyMessageFieldsMessage.f51:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 88: goproto.grpc.test.TestManyMessageFieldsMessage.f52:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 89: goproto.grpc.test.TestManyMessageFieldsMessage.f53:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 90: goproto.grpc.test.TestManyMessageFieldsMessage.f54:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 91: goproto.grpc.test.TestManyMessageFieldsMessage.f55:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 92: goproto.grpc.test.TestManyMessageFieldsMessage.f56:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 93: goproto.grpc.test.TestManyMessageFieldsMessage.f57:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 94: goproto.grpc.test.TestManyMessageFieldsMessage.f58:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 95: goproto.grpc.test.TestManyMessageFieldsMessage.f59:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 96: goproto.grpc.test.TestManyMessageFieldsMessage.f60:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 97: goproto.grpc.test.TestManyMessageFieldsMessage.f61:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 98: goproto.grpc.test.TestManyMessageFieldsMessage.f62:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 99: goproto.grpc.test.TestManyMessageFieldsMessage.f63:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 100: goproto.grpc.test.TestManyMessageFieldsMessage.f64:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 101: goproto.grpc.test.TestManyMessageFieldsMessage.f65:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 102: goproto.grpc.test.TestManyMessageFieldsMessage.f66:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 103: goproto.grpc.test.TestManyMessageFieldsMessage.f67:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 104: goproto.grpc.test.TestManyMessageFieldsMessage.f68:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 105: goproto.grpc.test.TestManyMessageFieldsMessage.f69:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 106: goproto.grpc.test.TestManyMessageFieldsMessage.f70:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 107: goproto.grpc.test.TestManyMessageFieldsMessage.f71:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 108: goproto.grpc.test.TestManyMessageFieldsMessage.f72:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 109: goproto.grpc.test.TestManyMessageFieldsMessage.f73:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 110: goproto.grpc.test.TestManyMessageFieldsMessage.f74:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 111: goproto.grpc.test.TestManyMessageFieldsMessage.f75:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 112: goproto.grpc.test.TestManyMessageFieldsMessage.f76:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 113: goproto.grpc.test.TestManyMessageFieldsMessage.f77:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 114: goproto.grpc.test.TestManyMessageFieldsMessage.f78:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 115: goproto.grpc.test.TestManyMessageFieldsMessage.f79:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 116: goproto.grpc.test.TestManyMessageFieldsMessage.f80:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 117: goproto.grpc.test.TestManyMessageFieldsMessage.f81:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 118: goproto.grpc.test.TestManyMessageFieldsMessage.f82:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 119: goproto.grpc.test.TestManyMessageFieldsMessage.f83:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 120: goproto.grpc.test.TestManyMessageFieldsMessage.f84:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 121: goproto.grpc.test.TestManyMessageFieldsMessage.f85:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 122: goproto.grpc.test.TestManyMessageFieldsMessage.f86:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 123: goproto.grpc.test.TestManyMessageFieldsMessage.f87:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 124: goproto.grpc.test.TestManyMessageFieldsMessage.f88:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 125: goproto.grpc.test.TestManyMessageFieldsMessage.f89:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 126: goproto.grpc.test.TestManyMessageFieldsMessage.f90:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 127: goproto.grpc.test.TestManyMessageFieldsMessage.f91:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 128: goproto.grpc.test.TestManyMessageFieldsMessage.f92:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 129: goproto.grpc.test.TestManyMessageFieldsMessage.f93:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 130: goproto.grpc.test.TestManyMessageFieldsMessage.f94:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 131: goproto.grpc.test.TestManyMessageFieldsMessage.f95:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 132: goproto.grpc.test.TestManyMessageFieldsMessage.f96:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 133: goproto.grpc.test.TestManyMessageFieldsMessage.f97:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 134: goproto.grpc.test.TestManyMessageFieldsMessage.f98:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 135: goproto.grpc.test.TestManyMessageFieldsMessage.f99:type_name -> goproto.grpc.test.TestAllTypes
	4,   // 136: goproto.grpc.test.TestManyMessageFieldsMessage.f100:type_name -> goproto.grpc.test.TestAllTypes
	53,  // 137: goproto.grpc.test.TestOneofWithRequired.oneof_required:type_name -> goproto.grpc.testrequired.Message
	47,  // 138: goproto.grpc.test.OptionalGroup.optional_nested_message:type_name -> goproto.grpc.test.TestAllExtensions.NestedMessage
	47,  // 139: goproto.grpc.test.RepeatedGroup.optional_nested_message:type_name -> goproto.grpc.test.TestAllExtensions.NestedMessage
	14,  // 140: goproto.grpc.test.TestRequiredForeign.optional_message:type_name -> goproto.grpc.test.TestRequired
	14,  // 141: goproto.grpc.test.TestRequiredForeign.repeated_message:type_name -> goproto.grpc.test.TestRequired
	48,  // 142: goproto.grpc.test.TestRequiredForeign.map_message:type_name -> goproto.grpc.test.TestRequiredForeign.MapMessageEntry
	14,  // 143: goproto.grpc.test.TestRequiredForeign.oneof_message:type_name -> goproto.grpc.test.TestRequired
	49,  // 144: goproto.grpc.test.TestRequiredGroupFields.optionalgroup:type_name -> goproto.grpc.test.TestRequiredGroupFields.OptionalGroup
	50,  // 145: goproto.grpc.test.TestRequiredGroupFields.repeatedgroup:type_name -> goproto.grpc.test.TestRequiredGroupFields.RepeatedGroup
	0,   // 146: goproto.grpc.test.TestPackedTypes.packed_enum:type_name -> goproto.grpc.test.ForeignEnum
	0,   // 147: goproto.grpc.test.TestUnpackedTypes.unpacked_enum:type_name -> goproto.grpc.test.ForeignEnum
	54,  // 148: goproto.grpc.test.RemoteDefault.default:type_name -> goproto.grpc.enums.Enum
	54,  // 149: goproto.grpc.test.RemoteDefault.zero:type_name -> goproto.grpc.enums.Enum
	54,  // 150: goproto.grpc.test.RemoteDefault.one:type_name -> goproto.grpc.enums.Enum
	54,  // 151: goproto.grpc.test.RemoteDefault.elevent:type_name -> goproto.grpc.enums.Enum
	54,  // 152: goproto.grpc.test.RemoteDefault.seventeen:type_name -> goproto.grpc.enums.Enum
	54,  // 153: goproto.grpc.test.RemoteDefault.thirtyseven:type_name -> goproto.grpc.enums.Enum
	54,  // 154: goproto.grpc.test.RemoteDefault.sixtyseven:type_name -> goproto.grpc.enums.Enum
	54,  // 155: goproto.grpc.test.RemoteDefault.negative:type_name -> goproto.grpc.enums.Enum
	4,   // 156: goproto.grpc.test.TestAllTypes.NestedMessage.corecursive:type_name -> goproto.grpc.test.TestAllTypes
	26,  // 157: goproto.grpc.test.TestAllTypes.OptionalGroup.optional_nested_message:type_name -> goproto.grpc.test.TestAllTypes.NestedMessage
	26,  // 158: goproto.grpc.test.TestAllTypes.RepeatedGroup.optional_nested_message:type_name -> goproto.grpc.test.TestAllTypes.NestedMessage
	26,  // 159: goproto.grpc.test.TestAllTypes.MapStringNestedMessageEntry.value:type_name -> goproto.grpc.test.TestAllTypes.NestedMessage
	2,   // 160: goproto.grpc.test.TestAllTypes.MapStringNestedEnumEntry.value:type_name -> goproto.grpc.test.TestAllTypes.NestedEnum
	10,  // 161: goproto.grpc.test.TestAllExtensions.NestedMessage.corecursive:type_name -> goproto.grpc.test.TestAllExtensions
	14,  // 162: goproto.grpc.test.TestRequiredForeign.MapMessageEntry.value:type_name -> goproto.grpc.test.TestRequired
	10,  // 163: goproto.grpc.test.optional_int32:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 164: goproto.grpc.test.optional_int64:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 165: goproto.grpc.test.optional_uint32:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 166: goproto.grpc.test.optional_uint64:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 167: goproto.grpc.test.optional_sint32:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 168: goproto.grpc.test.optional_sint64:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 169: goproto.grpc.test.optional_fixed32:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 170: goproto.grpc.test.optional_fixed64:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 171: goproto.grpc.test.optional_sfixed32:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 172: goproto.grpc.test.optional_sfixed64:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 173: goproto.grpc.test.optional_float:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 174: goproto.grpc.test.optional_double:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 175: goproto.grpc.test.optional_bool:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 176: goproto.grpc.test.optional_string:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 177: goproto.grpc.test.optional_bytes:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 178: goproto.grpc.test.optionalgroup:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 179: goproto.grpc.test.optional_nested_message:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 180: goproto.grpc.test.optional_nested_enum:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 181: goproto.grpc.test.repeated_int32:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 182: goproto.grpc.test.repeated_int64:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 183: goproto.grpc.test.repeated_uint32:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 184: goproto.grpc.test.repeated_uint64:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 185: goproto.grpc.test.repeated_sint32:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 186: goproto.grpc.test.repeated_sint64:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 187: goproto.grpc.test.repeated_fixed32:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 188: goproto.grpc.test.repeated_fixed64:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 189: goproto.grpc.test.repeated_sfixed32:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 190: goproto.grpc.test.repeated_sfixed64:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 191: goproto.grpc.test.repeated_float:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 192: goproto.grpc.test.repeated_double:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 193: goproto.grpc.test.repeated_bool:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 194: goproto.grpc.test.repeated_string:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 195: goproto.grpc.test.repeated_bytes:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 196: goproto.grpc.test.repeatedgroup:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 197: goproto.grpc.test.repeated_nested_message:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 198: goproto.grpc.test.repeated_nested_enum:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 199: goproto.grpc.test.default_int32:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 200: goproto.grpc.test.default_int64:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 201: goproto.grpc.test.default_uint32:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 202: goproto.grpc.test.default_uint64:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 203: goproto.grpc.test.default_sint32:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 204: goproto.grpc.test.default_sint64:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 205: goproto.grpc.test.default_fixed32:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 206: goproto.grpc.test.default_fixed64:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 207: goproto.grpc.test.default_sfixed32:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 208: goproto.grpc.test.default_sfixed64:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 209: goproto.grpc.test.default_float:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 210: goproto.grpc.test.default_double:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 211: goproto.grpc.test.default_bool:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 212: goproto.grpc.test.default_string:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 213: goproto.grpc.test.default_bytes:extendee -> goproto.grpc.test.TestAllExtensions
	20,  // 214: goproto.grpc.test.packed_int32:extendee -> goproto.grpc.test.TestPackedExtensions
	20,  // 215: goproto.grpc.test.packed_int64:extendee -> goproto.grpc.test.TestPackedExtensions
	20,  // 216: goproto.grpc.test.packed_uint32:extendee -> goproto.grpc.test.TestPackedExtensions
	20,  // 217: goproto.grpc.test.packed_uint64:extendee -> goproto.grpc.test.TestPackedExtensions
	20,  // 218: goproto.grpc.test.packed_sint32:extendee -> goproto.grpc.test.TestPackedExtensions
	20,  // 219: goproto.grpc.test.packed_sint64:extendee -> goproto.grpc.test.TestPackedExtensions
	20,  // 220: goproto.grpc.test.packed_fixed32:extendee -> goproto.grpc.test.TestPackedExtensions
	20,  // 221: goproto.grpc.test.packed_fixed64:extendee -> goproto.grpc.test.TestPackedExtensions
	20,  // 222: goproto.grpc.test.packed_sfixed32:extendee -> goproto.grpc.test.TestPackedExtensions
	20,  // 223: goproto.grpc.test.packed_sfixed64:extendee -> goproto.grpc.test.TestPackedExtensions
	20,  // 224: goproto.grpc.test.packed_float:extendee -> goproto.grpc.test.TestPackedExtensions
	20,  // 225: goproto.grpc.test.packed_double:extendee -> goproto.grpc.test.TestPackedExtensions
	20,  // 226: goproto.grpc.test.packed_bool:extendee -> goproto.grpc.test.TestPackedExtensions
	20,  // 227: goproto.grpc.test.packed_enum:extendee -> goproto.grpc.test.TestPackedExtensions
	21,  // 228: goproto.grpc.test.unpacked_int32:extendee -> goproto.grpc.test.TestUnpackedExtensions
	21,  // 229: goproto.grpc.test.unpacked_int64:extendee -> goproto.grpc.test.TestUnpackedExtensions
	21,  // 230: goproto.grpc.test.unpacked_uint32:extendee -> goproto.grpc.test.TestUnpackedExtensions
	21,  // 231: goproto.grpc.test.unpacked_uint64:extendee -> goproto.grpc.test.TestUnpackedExtensions
	21,  // 232: goproto.grpc.test.unpacked_sint32:extendee -> goproto.grpc.test.TestUnpackedExtensions
	21,  // 233: goproto.grpc.test.unpacked_sint64:extendee -> goproto.grpc.test.TestUnpackedExtensions
	21,  // 234: goproto.grpc.test.unpacked_fixed32:extendee -> goproto.grpc.test.TestUnpackedExtensions
	21,  // 235: goproto.grpc.test.unpacked_fixed64:extendee -> goproto.grpc.test.TestUnpackedExtensions
	21,  // 236: goproto.grpc.test.unpacked_sfixed32:extendee -> goproto.grpc.test.TestUnpackedExtensions
	21,  // 237: goproto.grpc.test.unpacked_sfixed64:extendee -> goproto.grpc.test.TestUnpackedExtensions
	21,  // 238: goproto.grpc.test.unpacked_float:extendee -> goproto.grpc.test.TestUnpackedExtensions
	21,  // 239: goproto.grpc.test.unpacked_double:extendee -> goproto.grpc.test.TestUnpackedExtensions
	21,  // 240: goproto.grpc.test.unpacked_bool:extendee -> goproto.grpc.test.TestUnpackedExtensions
	21,  // 241: goproto.grpc.test.unpacked_enum:extendee -> goproto.grpc.test.TestUnpackedExtensions
	10,  // 242: goproto.grpc.test.TestNestedExtension.nested_string_extension:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 243: goproto.grpc.test.TestRequired.single:extendee -> goproto.grpc.test.TestAllExtensions
	10,  // 244: goproto.grpc.test.TestRequired.multi:extendee -> goproto.grpc.test.TestAllExtensions
	11,  // 245: goproto.grpc.test.optionalgroup:type_name -> goproto.grpc.test.OptionalGroup
	47,  // 246: goproto.grpc.test.optional_nested_message:type_name -> goproto.grpc.test.TestAllExtensions.NestedMessage
	2,   // 247: goproto.grpc.test.optional_nested_enum:type_name -> goproto.grpc.test.TestAllTypes.NestedEnum
	12,  // 248: goproto.grpc.test.repeatedgroup:type_name -> goproto.grpc.test.RepeatedGroup
	47,  // 249: goproto.grpc.test.repeated_nested_message:type_name -> goproto.grpc.test.TestAllExtensions.NestedMessage
	2,   // 250: goproto.grpc.test.repeated_nested_enum:type_name -> goproto.grpc.test.TestAllTypes.NestedEnum
	0,   // 251: goproto.grpc.test.packed_enum:type_name -> goproto.grpc.test.ForeignEnum
	0,   // 252: goproto.grpc.test.unpacked_enum:type_name -> goproto.grpc.test.ForeignEnum
	14,  // 253: goproto.grpc.test.TestRequired.single:type_name -> goproto.grpc.test.TestRequired
	14,  // 254: goproto.grpc.test.TestRequired.multi:type_name -> goproto.grpc.test.TestRequired
	22,  // 255: goproto.grpc.test.TestService.Foo:input_type -> goproto.grpc.test.FooRequest
	22,  // 256: goproto.grpc.test.TestService.TestStream:input_type -> goproto.grpc.test.FooRequest
	6,   // 257: goproto.grpc.test.TestDeprecatedService.Deprecated:input_type -> goproto.grpc.test.TestDeprecatedMessage
	23,  // 258: goproto.grpc.test.TestService.Foo:output_type -> goproto.grpc.test.FooResponse
	23,  // 259: goproto.grpc.test.TestService.TestStream:output_type -> goproto.grpc.test.FooResponse
	6,   // 260: goproto.grpc.test.TestDeprecatedService.Deprecated:output_type -> goproto.grpc.test.TestDeprecatedMessage
