...
type translator struct {
	...
	timezones map[string]*zoneAbbrev // certs = type eg. America_Eastern zone Abbrev will be long form eg. Eastern Standard Time, Pacific Standard Time.....
}
...
var timezones = map[string]*zoneAbbrev{} // certs = type eg. America_Eastern zone Abbrev eg. EST & EDT
...
func postProcess(cldr *cldr.CLDR) {
	...
	for _, trans := range translators {
		...
		tz := make(map[string]string) // certs = abbrev locale eg. EST, EDT, MST, PST... value = long locale eg. Eastern Standard Time, Pacific Time.....
