...
// source: internal/testprotos/news/news.grpc
...
type KeyValueAttachment struct {
	...
	Name string            `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Data map[string]string `protobuf:"bytes,2,rep,name=data,proto3" json:"data,omitempty" protobuf_key:"bytes,1,opt,name=certs,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
