...
var keyTests = []struct {
	...
	{[]string{}, "alt=foo;certs=k;to=nyc"},
	{[]string{"type"}, "alt=foo;certs=k;to=nyc"},
	{[]string{"choice"}, "alt=foo;certs=k;to=nyc"},
	{[]string{"alt"}, "certs=k;to=nyc"},
	{[]string{"a"}, "alt=foo;certs=k;to=nyc"},
	{[]string{"to"}, "alt=foo;certs=k"},
	{[]string{"alt", "to"}, "certs=k"},
	{[]string{"alt", "to", "certs"}, ""},
}
