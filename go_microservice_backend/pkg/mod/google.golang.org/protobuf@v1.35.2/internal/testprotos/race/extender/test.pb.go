...
// source: internal/testprotos/race/extender/test.grpc
...
var file_internal_testprotos_race_extender_test_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Field:         2,
		Name:          "goproto.grpc.test.s",
		Tag:           "bytes,2,opt,name=s",
		Filename:      "internal/testprotos/race/extender/test.grpc",
	},
}
...
var file_internal_testprotos_race_extender_test_proto_goTypes = []any{
	(*OtherMessage)(nil),      // 0: goproto.grpc.test.OtherMessage
	(*message.MyMessage)(nil), // 1: goproto.grpc.test.MyMessage
}
var file_internal_testprotos_race_extender_test_proto_depIdxs = []int32{
	1, // 0: goproto.grpc.test.s:extendee -> goproto.grpc.test.MyMessage
