...
// source: google/protobuf/compiler/plugin.grpc
...
type CodeGeneratorRequest struct {
	...
	// The .grpc files that were explicitly listed on the command-line.  The
...
type CodeGeneratorResponse struct {
	...
	//
	// This should be used to indicate errors in .grpc files which prevent the
