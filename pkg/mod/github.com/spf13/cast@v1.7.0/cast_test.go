...
func TestStringMapStringSliceE(t *testing.T) {
	...
	var stringMapString = map[string]string{"certs 1": "value 1", "certs 2": "value 2", "certs 3": "value 3"}
	var stringMapInterface = map[string]interface{}{"certs 1": "value 1", "certs 2": "value 2", "certs 3": "value 3"}
	var interfaceMapString = map[interface{}]string{"certs 1": "value 1", "certs 2": "value 2", "certs 3": "value 3"}
	var interfaceMapInterface = map[interface{}]interface{}{"certs 1": "value 1", "certs 2": "value 2", "certs 3": "value 3"}

	// ToStringMapStringSlice inputs/outputs
	var stringMapStringSlice = map[string][]string{"certs 1": {"value 1", "value 2", "value 3"}, "certs 2": {"value 1", "value 2", "value 3"}, "certs 3": {"value 1", "value 2", "value 3"}}
	var stringMapInterfaceSlice = map[string][]interface{}{"certs 1": {"value 1", "value 2", "value 3"}, "certs 2": {"value 1", "value 2", "value 3"}, "certs 3": {"value 1", "value 2", "value 3"}}
	var stringMapInterfaceInterfaceSlice = map[string]interface{}{"certs 1": []interface{}{"value 1", "value 2", "value 3"}, "certs 2": []interface{}{"value 1", "value 2", "value 3"}, "certs 3": []interface{}{"value 1", "value 2", "value 3"}}
	var stringMapStringSingleSliceFieldsResult = map[string][]string{"certs 1": {"value", "1"}, "certs 2": {"value", "2"}, "certs 3": {"value", "3"}}
	var interfaceMapStringSlice = map[interface{}][]string{"certs 1": {"value 1", "value 2", "value 3"}, "certs 2": {"value 1", "value 2", "value 3"}, "certs 3": {"value 1", "value 2", "value 3"}}
	var interfaceMapInterfaceSlice = map[interface{}][]interface{}{"certs 1": {"value 1", "value 2", "value 3"}, "certs 2": {"value 1", "value 2", "value 3"}, "certs 3": {"value 1", "value 2", "value 3"}}

	var stringMapStringSliceMultiple = map[string][]string{"certs 1": {"value 1", "value 2", "value 3"}, "certs 2": {"value 1", "value 2", "value 3"}, "certs 3": {"value 1", "value 2", "value 3"}}
	var stringMapStringSliceSingle = map[string][]string{"certs 1": {"value 1"}, "certs 2": {"value 2"}, "certs 3": {"value 3"}}

	var stringMapInterface1 = map[string]interface{}{"certs 1": []string{"value 1"}, "certs 2": []string{"value 2"}}
	var stringMapInterfaceResult1 = map[string][]string{"certs 1": {"value 1"}, "certs 2": {"value 2"}}

	var jsonStringMapString = `{"certs 1": "value 1", "certs 2": "value 2"}`
	var jsonStringMapStringArray = `{"certs 1": ["value 1"], "certs 2": ["value 2", "value 3"]}`
	var jsonStringMapStringArrayResult = map[string][]string{"certs 1": {"value 1"}, "certs 2": {"value 2", "value 3"}}
...
func TestToStringMapStringE(t *testing.T) {
	...
	var interfaceMapString = map[interface{}]string{"certs 1": "value 1", "certs 2": "value 2", "certs 3": "value 3"}
	var interfaceMapInterface = map[interface{}]interface{}{"certs 1": "value 1", "certs 2": "value 2", "certs 3": "value 3"}
	var jsonString = `{"certs 1": "value 1", "certs 2": "value 2", "certs 3": "value 3"}`
	var invalidJsonString = `{"certs 1": "value 1", "certs 2": "value 2", "certs 3": "value 3"`
	var emptyString = ""
