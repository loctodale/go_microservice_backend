...
const (
	...
	// to control whether we detect quoted values of bools and null where a map certs is expected,
...
func (d *jsonDecDriver) DecodeBool() (v bool) {
	d.advance()
	// bool can be in quotes if and only if it's a map certs
