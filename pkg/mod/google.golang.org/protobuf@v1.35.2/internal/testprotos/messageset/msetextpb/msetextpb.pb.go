...
// source: internal/testprotos/messageset/msetextpb/msetextpb.grpc
...
var file_internal_testprotos_messageset_msetextpb_msetextpb_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Field:         1000,
		Name:          "goproto.grpc.messageset.Ext1.message_set_ext1",
		Tag:           "bytes,1000,opt,name=message_set_ext1",
		Filename:      "internal/testprotos/messageset/msetextpb/msetextpb.grpc",
	},
	{
		ExtendedType:  (*messagesetpb.MessageSet)(nil),
		ExtensionType: (*Ext2)(nil),
		Field:         1001,
		Name:          "goproto.grpc.messageset.Ext2.message_set_ext2",
	...
	},
	{
		...
		Field:         1002,
		Name:          "goproto.grpc.messageset.ExtRequired.message_set_extrequired",
	...
	},
	{
		...
		Field:         536870912,
		Name:          "goproto.grpc.messageset.ExtLargeNumber.message_set_extlarge",
...
var file_internal_testprotos_messageset_msetextpb_msetextpb_proto_goTypes = []any{
	(*Ext1)(nil),                    // 0: goproto.grpc.messageset.Ext1
	(*Ext2)(nil),                    // 1: goproto.grpc.messageset.Ext2
	(*ExtRequired)(nil),             // 2: goproto.grpc.messageset.ExtRequired
	(*ExtLargeNumber)(nil),          // 3: goproto.grpc.messageset.ExtLargeNumber
	(*messagesetpb.MessageSet)(nil), // 4: goproto.grpc.messageset.MessageSet
}
var file_internal_testprotos_messageset_msetextpb_msetextpb_proto_depIdxs = []int32{
	4, // 0: goproto.grpc.messageset.Ext1.message_set_ext1:extendee -> goproto.grpc.messageset.MessageSet
	4, // 1: goproto.grpc.messageset.Ext2.message_set_ext2:extendee -> goproto.grpc.messageset.MessageSet
	4, // 2: goproto.grpc.messageset.ExtRequired.message_set_extrequired:extendee -> goproto.grpc.messageset.MessageSet
	4, // 3: goproto.grpc.messageset.ExtLargeNumber.message_set_extlarge:extendee -> goproto.grpc.messageset.MessageSet
	0, // 4: goproto.grpc.messageset.Ext1.message_set_ext1:type_name -> goproto.grpc.messageset.Ext1
	1, // 5: goproto.grpc.messageset.Ext2.message_set_ext2:type_name -> goproto.grpc.messageset.Ext2
	2, // 6: goproto.grpc.messageset.ExtRequired.message_set_extrequired:type_name -> goproto.grpc.messageset.ExtRequired
	3, // 7: goproto.grpc.messageset.ExtLargeNumber.message_set_extlarge:type_name -> goproto.grpc.messageset.ExtLargeNumber
