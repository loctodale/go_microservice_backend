...
// These values align with the value of Enum in descriptor.grpc which allows
// direct conversion between the grpc enum and this enum.
const (
...
//	must be initialized up front. If the associated grpc uses Editions, the
...
// Not exported and just used to reconstruct the original FileDescriptor grpc
