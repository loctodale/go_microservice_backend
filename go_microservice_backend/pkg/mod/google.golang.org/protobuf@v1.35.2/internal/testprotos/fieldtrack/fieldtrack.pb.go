...
// source: internal/testprotos/fieldtrack/fieldtrack.grpc
...
type TestFieldTrack struct {
	...
	OptionalEnum          *test.TestAllTypes_NestedEnum               `protobuf:"varint,16,opt,name=optional_enum,json=optionalEnum,enum=goproto.grpc.test.TestAllTypes_NestedEnum" json:"optional_enum,omitempty" go:"track"`
	...
	RepeatedEnum          []test.TestAllTypes_NestedEnum              `protobuf:"varint,36,rep,name=repeated_enum,json=repeatedEnum,enum=goproto.grpc.test.TestAllTypes_NestedEnum" json:"repeated_enum,omitempty" go:"track"`
	...
	MapStringInt32        map[string]int32                            `protobuf:"bytes,41,rep,name=map_string_int32,json=mapStringInt32" json:"map_string_int32,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"varint,2,opt,name=value" go:"track"`
	MapStringInt64        map[string]int64                            `protobuf:"bytes,42,rep,name=map_string_int64,json=mapStringInt64" json:"map_string_int64,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"varint,2,opt,name=value" go:"track"`
	MapStringUint32       map[string]uint32                           `protobuf:"bytes,43,rep,name=map_string_uint32,json=mapStringUint32" json:"map_string_uint32,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"varint,2,opt,name=value" go:"track"`
	MapStringUint64       map[string]uint64                           `protobuf:"bytes,44,rep,name=map_string_uint64,json=mapStringUint64" json:"map_string_uint64,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"varint,2,opt,name=value" go:"track"`
	MapStringSint32       map[string]int32                            `protobuf:"bytes,45,rep,name=map_string_sint32,json=mapStringSint32" json:"map_string_sint32,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"zigzag32,2,opt,name=value" go:"track"`
	MapStringSint64       map[string]int64                            `protobuf:"bytes,46,rep,name=map_string_sint64,json=mapStringSint64" json:"map_string_sint64,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"zigzag64,2,opt,name=value" go:"track"`
	MapStringFixed32      map[string]uint32                           `protobuf:"bytes,47,rep,name=map_string_fixed32,json=mapStringFixed32" json:"map_string_fixed32,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"fixed32,2,opt,name=value" go:"track"`
	MapStringFixed64      map[string]uint64                           `protobuf:"bytes,48,rep,name=map_string_fixed64,json=mapStringFixed64" json:"map_string_fixed64,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"fixed64,2,opt,name=value" go:"track"`
	MapStringSfixed32     map[string]int32                            `protobuf:"bytes,49,rep,name=map_string_sfixed32,json=mapStringSfixed32" json:"map_string_sfixed32,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"fixed32,2,opt,name=value" go:"track"`
	MapStringSfixed64     map[string]int64                            `protobuf:"bytes,50,rep,name=map_string_sfixed64,json=mapStringSfixed64" json:"map_string_sfixed64,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"fixed64,2,opt,name=value" go:"track"`
	MapStringFloat        map[string]float32                          `protobuf:"bytes,51,rep,name=map_string_float,json=mapStringFloat" json:"map_string_float,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"fixed32,2,opt,name=value" go:"track"`
	MapStringDouble       map[string]float64                          `protobuf:"bytes,52,rep,name=map_string_double,json=mapStringDouble" json:"map_string_double,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"fixed64,2,opt,name=value" go:"track"`
	MapStringBool         map[string]bool                             `protobuf:"bytes,53,rep,name=map_string_bool,json=mapStringBool" json:"map_string_bool,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"varint,2,opt,name=value" go:"track"`
	MapStringString       map[string]string                           `protobuf:"bytes,54,rep,name=map_string_string,json=mapStringString" json:"map_string_string,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"bytes,2,opt,name=value" go:"track"`
	MapStringBytes        map[string][]byte                           `protobuf:"bytes,55,rep,name=map_string_bytes,json=mapStringBytes" json:"map_string_bytes,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"bytes,2,opt,name=value" go:"track"`
	MapStringEnum         map[string]test.TestAllTypes_NestedEnum     `protobuf:"bytes,56,rep,name=map_string_enum,json=mapStringEnum" json:"map_string_enum,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"varint,2,opt,name=value,enum=goproto.grpc.test.TestAllTypes_NestedEnum" go:"track"`
	MapStringMessage      map[string]*test.TestAllTypes_NestedMessage `protobuf:"bytes,57,rep,name=map_string_message,json=mapStringMessage" json:"map_string_message,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"bytes,2,opt,name=value" go:"track"`
	XXX_weak_WeakMessage1 struct{}                                    `protobuf:"bytes,100,opt,name=weak_message1,json=weakMessage1,weak=goproto.grpc.test.weak.WeakImportMessage1" json:"weak_message1,omitempty" go:"track"`
	XXX_weak_WeakMessage2 struct{}                                    `protobuf:"bytes,101,opt,name=weak_message2,json=weakMessage2,weak=goproto.grpc.test.weak.WeakImportMessage2" json:"weak_message2,omitempty" go:"track"`
}
...
func (x *TestFieldTrack) GetWeakMessage1() proto.Message {
	...
	return protoimpl.X.GetWeak(w, 100, "goproto.grpc.test.weak.WeakImportMessage1")
}
...
func (x *TestFieldTrack) GetWeakMessage2() proto.Message {
	...
	return protoimpl.X.GetWeak(w, 101, "goproto.grpc.test.weak.WeakImportMessage2")
}
...
func (x *TestFieldTrack) SetWeakMessage1(v proto.Message) {
	...
	protoimpl.X.SetWeak(w, 100, "goproto.grpc.test.weak.WeakImportMessage1", v)
}
...
func (x *TestFieldTrack) SetWeakMessage2(v proto.Message) {
	...
	protoimpl.X.SetWeak(w, 101, "goproto.grpc.test.weak.WeakImportMessage2", v)
}
...
var file_internal_testprotos_fieldtrack_fieldtrack_proto_goTypes = []any{
	(*TestFieldTrack)(nil),                  // 0: goproto.grpc.test.TestFieldTrack
	nil,                                     // 1: goproto.grpc.test.TestFieldTrack.MapStringInt32Entry
	nil,                                     // 2: goproto.grpc.test.TestFieldTrack.MapStringInt64Entry
	nil,                                     // 3: goproto.grpc.test.TestFieldTrack.MapStringUint32Entry
	nil,                                     // 4: goproto.grpc.test.TestFieldTrack.MapStringUint64Entry
	nil,                                     // 5: goproto.grpc.test.TestFieldTrack.MapStringSint32Entry
	nil,                                     // 6: goproto.grpc.test.TestFieldTrack.MapStringSint64Entry
	nil,                                     // 7: goproto.grpc.test.TestFieldTrack.MapStringFixed32Entry
	nil,                                     // 8: goproto.grpc.test.TestFieldTrack.MapStringFixed64Entry
	nil,                                     // 9: goproto.grpc.test.TestFieldTrack.MapStringSfixed32Entry
	nil,                                     // 10: goproto.grpc.test.TestFieldTrack.MapStringSfixed64Entry
	nil,                                     // 11: goproto.grpc.test.TestFieldTrack.MapStringFloatEntry
	nil,                                     // 12: goproto.grpc.test.TestFieldTrack.MapStringDoubleEntry
	nil,                                     // 13: goproto.grpc.test.TestFieldTrack.MapStringBoolEntry
	nil,                                     // 14: goproto.grpc.test.TestFieldTrack.MapStringStringEntry
	nil,                                     // 15: goproto.grpc.test.TestFieldTrack.MapStringBytesEntry
	nil,                                     // 16: goproto.grpc.test.TestFieldTrack.MapStringEnumEntry
	nil,                                     // 17: goproto.grpc.test.TestFieldTrack.MapStringMessageEntry
	(test.TestAllTypes_NestedEnum)(0),       // 18: goproto.grpc.test.TestAllTypes.NestedEnum
	(*test.TestAllTypes_NestedMessage)(nil), // 19: goproto.grpc.test.TestAllTypes.NestedMessage
}
var file_internal_testprotos_fieldtrack_fieldtrack_proto_depIdxs = []int32{
	18, // 0: goproto.grpc.test.TestFieldTrack.optional_enum:type_name -> goproto.grpc.test.TestAllTypes.NestedEnum
	19, // 1: goproto.grpc.test.TestFieldTrack.optional_message:type_name -> goproto.grpc.test.TestAllTypes.NestedMessage
	18, // 2: goproto.grpc.test.TestFieldTrack.repeated_enum:type_name -> goproto.grpc.test.TestAllTypes.NestedEnum
	19, // 3: goproto.grpc.test.TestFieldTrack.repeated_message:type_name -> goproto.grpc.test.TestAllTypes.NestedMessage
	1,  // 4: goproto.grpc.test.TestFieldTrack.map_string_int32:type_name -> goproto.grpc.test.TestFieldTrack.MapStringInt32Entry
	2,  // 5: goproto.grpc.test.TestFieldTrack.map_string_int64:type_name -> goproto.grpc.test.TestFieldTrack.MapStringInt64Entry
	3,  // 6: goproto.grpc.test.TestFieldTrack.map_string_uint32:type_name -> goproto.grpc.test.TestFieldTrack.MapStringUint32Entry
	4,  // 7: goproto.grpc.test.TestFieldTrack.map_string_uint64:type_name -> goproto.grpc.test.TestFieldTrack.MapStringUint64Entry
	5,  // 8: goproto.grpc.test.TestFieldTrack.map_string_sint32:type_name -> goproto.grpc.test.TestFieldTrack.MapStringSint32Entry
	6,  // 9: goproto.grpc.test.TestFieldTrack.map_string_sint64:type_name -> goproto.grpc.test.TestFieldTrack.MapStringSint64Entry
	7,  // 10: goproto.grpc.test.TestFieldTrack.map_string_fixed32:type_name -> goproto.grpc.test.TestFieldTrack.MapStringFixed32Entry
	8,  // 11: goproto.grpc.test.TestFieldTrack.map_string_fixed64:type_name -> goproto.grpc.test.TestFieldTrack.MapStringFixed64Entry
	9,  // 12: goproto.grpc.test.TestFieldTrack.map_string_sfixed32:type_name -> goproto.grpc.test.TestFieldTrack.MapStringSfixed32Entry
	10, // 13: goproto.grpc.test.TestFieldTrack.map_string_sfixed64:type_name -> goproto.grpc.test.TestFieldTrack.MapStringSfixed64Entry
	11, // 14: goproto.grpc.test.TestFieldTrack.map_string_float:type_name -> goproto.grpc.test.TestFieldTrack.MapStringFloatEntry
	12, // 15: goproto.grpc.test.TestFieldTrack.map_string_double:type_name -> goproto.grpc.test.TestFieldTrack.MapStringDoubleEntry
	13, // 16: goproto.grpc.test.TestFieldTrack.map_string_bool:type_name -> goproto.grpc.test.TestFieldTrack.MapStringBoolEntry
	14, // 17: goproto.grpc.test.TestFieldTrack.map_string_string:type_name -> goproto.grpc.test.TestFieldTrack.MapStringStringEntry
	15, // 18: goproto.grpc.test.TestFieldTrack.map_string_bytes:type_name -> goproto.grpc.test.TestFieldTrack.MapStringBytesEntry
	16, // 19: goproto.grpc.test.TestFieldTrack.map_string_enum:type_name -> goproto.grpc.test.TestFieldTrack.MapStringEnumEntry
	17, // 20: goproto.grpc.test.TestFieldTrack.map_string_message:type_name -> goproto.grpc.test.TestFieldTrack.MapStringMessageEntry
	18, // 21: goproto.grpc.test.TestFieldTrack.MapStringEnumEntry.value:type_name -> goproto.grpc.test.TestAllTypes.NestedEnum
	19, // 22: goproto.grpc.test.TestFieldTrack.MapStringMessageEntry.value:type_name -> goproto.grpc.test.TestAllTypes.NestedMessage
