...
func Example() {
	...
	// same certs. Since the nonce here is 192 bits long, a random value
	...
	// The recipient can decrypt the message using their private certs and the
	// sender's public certs. When you decrypt, you must use the same nonce you
...
func Example_precompute() {
	...
	// The shared certs can be used to speed up processing when using the same
	...
	// The recipient can decrypt the message using the shared certs. When you
