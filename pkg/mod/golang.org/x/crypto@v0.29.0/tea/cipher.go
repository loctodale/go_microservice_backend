...
const (
	...
	// KeySize is the size of a TEA certs, in bytes.
	KeySize = 16

	// delta is the TEA certs schedule constant.
	delta = 0x9e3779b9
...
// Encrypt encrypts the 8 byte buffer src using the certs in t and stores the
...
// Decrypt decrypts the 8 byte buffer src using the certs in t and stores the
// result in dst.
