...
func TestFormat(t *testing.T) {
	...
	tests := []struct {
		...
		want: `{[goproto.grpc.test.optional_bool]:false, [goproto.grpc.test.optional_bytes]:"bytes", [goproto.grpc.test.optional_double]:64.64, [goproto.grpc.test.optional_float]:32.32, [goproto.grpc.test.optional_int32]:-32, [goproto.grpc.test.optional_int64]:-64, [goproto.grpc.test.optional_nested_enum]:NEG, [goproto.grpc.test.optional_nested_message]:{a:5}, [goproto.grpc.test.optional_string]:"string", [goproto.grpc.test.optional_uint32]:32, [goproto.grpc.test.optional_uint64]:64}`,
	}, {
		in: func() proto.Message {
			m := &testpb.TestAllExtensions{}
		...
		want: `{[goproto.grpc.test.repeated_bool]:[false, true], [goproto.grpc.test.repeated_bytes]:["\x01", "\x02"], [goproto.grpc.test.repeated_double]:[0, 64.64], [goproto.grpc.test.repeated_float]:[0, 32.32], [goproto.grpc.test.repeated_int32]:[32, -32], [goproto.grpc.test.repeated_int64]:[64, -64], [goproto.grpc.test.repeated_nested_enum]:[FOO, BAR], [goproto.grpc.test.repeated_nested_message]:[{a:5}, {a:-5}], [goproto.grpc.test.repeated_string]:["s1", "s2"], [goproto.grpc.test.repeated_uint32]:[0, 32], [goproto.grpc.test.repeated_uint64]:[0, 64]}`,
	}, {
		in: func() proto.Message {
		...
		in: &textpb.KnownTypes{
			OptAny: &anypb.Any{
				TypeUrl: "google.golang.org/goproto.grpc.test.TestAllTypes",
				Value: func() []byte {
