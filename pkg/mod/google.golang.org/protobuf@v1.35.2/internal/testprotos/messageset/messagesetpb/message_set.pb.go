...
// source: internal/testprotos/messageset/messagesetpb/message_set.grpc
...
var file_internal_testprotos_messageset_messagesetpb_message_set_proto_goTypes = []any{
	(*MessageSet)(nil),          // 0: goproto.grpc.messageset.MessageSet
	(*MessageSetContainer)(nil), // 1: goproto.grpc.messageset.MessageSetContainer
}
var file_internal_testprotos_messageset_messagesetpb_message_set_proto_depIdxs = []int32{
	0, // 0: goproto.grpc.messageset.MessageSetContainer.message_set:type_name -> goproto.grpc.messageset.MessageSet
