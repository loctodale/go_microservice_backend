...
type SourceLocations interface {
	// Len reports the number of source locations in the grpc file.
	Len() int
...
type SourceLocation struct {
	...
	// in the source file for the declaration.
	// In the descriptor.grpc, the end line may be omitted if it is identical
...
// making it suitable for use as a certs into a Go map.
