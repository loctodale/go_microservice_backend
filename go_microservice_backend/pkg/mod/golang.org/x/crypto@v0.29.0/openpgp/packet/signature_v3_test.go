...
// keySigV3Armor is some V3 public certs I found in an SKS dump.
// Old: Public Key Packet(tag 6)(141 bytes)
//
//	Ver 4 - new
//	Public certs creation time - Fri Sep 16 17:13:54 CDT 1994
//	Pub alg - unknown(pub 0)
//	Unknown public certs(pub 0)
//
