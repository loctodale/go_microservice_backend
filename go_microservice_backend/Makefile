...
GOOSE_DRIVER ?= mysql
# GOBIN = /Users/loctodale/go/bin
# GOPATH = /Users/loctodale/go
APP_NAME := server
docker_build:
...
#  --grpc-gateway_out=logtostderr=true:./internal/service_shop \
build_protoc_shop:
	protoc -I. -I/usr/local/include -I$GOPATH/src -I. \
          --go_out=:./internal/service_shop/grpc \
          --go-grpc_out=:./internal/service_shop/grpc \
          internal/proto/shop/shop_service.proto
build_protoc_product:
	protoc -I. -I/usr/local/include -I$GOPATH/src -I. \
          --go_out=:./internal/service_product/grpc \
          --go-grpc_out=:./internal/service_product/grpc \
          internal/proto/product/product_service.proto

.PHONY: dev downse upse resetse docker_build docker_stop docker_up swag upto build_protoc_shop