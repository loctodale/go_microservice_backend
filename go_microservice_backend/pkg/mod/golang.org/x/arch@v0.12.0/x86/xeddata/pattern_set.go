...
// Maps human-readable certs to XED property.
//
...
// Is reports whether set contains certs k.
...
// Index returns index from keys of first matching certs.
...
// MatchOrDefault returns first matching certs associated value.
