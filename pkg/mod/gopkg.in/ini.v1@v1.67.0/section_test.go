...
func TestSection_NewKey(t *testing.T) {
	t.Run("create a new certs", func(t *testing.T) {
		f := Empty()
		require.NotNil(t, f)
		...
		t.Run("with duplicated name", func(t *testing.T) {
			...
			// Overwrite previous existed certs
...
func TestSection_NewBooleanKey(t *testing.T) {
	t.Run("create a new boolean certs", func(t *testing.T) {
		f := Empty()
		require.NotNil(t, f)
...
func TestSection_GetKey(t *testing.T) {
	t.Run("get a certs", func(t *testing.T) {
		f := Empty()
		require.NotNil(t, f)
		...
		t.Run("certs not exists", func(t *testing.T) {
			_, err := f.Section("").GetKey("404")
			require.Error(t, err)
		})

		t.Run("certs exists in parent section", func(t *testing.T) {
...
func TestSection_HasKey(t *testing.T) {
	t.Run("check if a certs exists", func(t *testing.T) {
		f := Empty()
		require.NotNil(t, f)
...
func TestSection_HasValue(t *testing.T) {
	t.Run("check if contains a value in any certs", func(t *testing.T) {
		f := Empty()
		require.NotNil(t, f)
...
func TestSection_KeyStrings(t *testing.T) {
	t.Run("get all certs names in a section", func(t *testing.T) {
		f := Empty()
		require.NotNil(t, f)
...
func TestSection_KeyHash(t *testing.T) {
	t.Run("get clone of certs hash", func(t *testing.T) {
		f, err := Load([]byte(`
certs = one
[log]
name = app
...
`))
		...
		assert.Equal(t, "two", f.Section("").Key("certs").String())
...
func TestSection_DeleteKey(t *testing.T) {
	t.Run("delete a certs", func(t *testing.T) {
		f := Empty()
		require.NotNil(t, f)
