...
// source: internal/testprotos/editionsfuzztest/test3editions.grpc
...
type TestAllTypesProto3Editions struct {
	...
	SingularNestedEnum     TestAllTypesProto3Editions_NestedEnum                `protobuf:"varint,101,opt,name=singular_nested_enum,json=singularNestedEnum,enum=goproto.grpc.test.TestAllTypesProto3Editions_NestedEnum" json:"singular_nested_enum,omitempty"`
	SingularForeignEnum    ForeignEnumProto3Editions                            `protobuf:"varint,102,opt,name=singular_foreign_enum,json=singularForeignEnum,enum=goproto.grpc.test.ForeignEnumProto3Editions" json:"singular_foreign_enum,omitempty"`
	...
	OptionalNestedEnum     *TestAllTypesProto3Editions_NestedEnum               `protobuf:"varint,21,opt,name=optional_nested_enum,json=optionalNestedEnum,enum=goproto.grpc.test.TestAllTypesProto3Editions_NestedEnum" json:"optional_nested_enum,omitempty"`
	OptionalForeignEnum    *ForeignEnumProto3Editions                           `protobuf:"varint,22,opt,name=optional_foreign_enum,json=optionalForeignEnum,enum=goproto.grpc.test.ForeignEnumProto3Editions" json:"optional_foreign_enum,omitempty"`
	...
	RepeatedNestedEnum     []TestAllTypesProto3Editions_NestedEnum              `protobuf:"varint,51,rep,packed,name=repeated_nested_enum,json=repeatedNestedEnum,enum=goproto.grpc.test.TestAllTypesProto3Editions_NestedEnum" json:"repeated_nested_enum,omitempty"`
	RepeatedForeignEnum    []ForeignEnumProto3Editions                          `protobuf:"varint,52,rep,packed,name=repeated_foreign_enum,json=repeatedForeignEnum,enum=goproto.grpc.test.ForeignEnumProto3Editions" json:"repeated_foreign_enum,omitempty"`
	...
	MapStringNestedMessage map[string]*TestAllTypesProto3Editions_NestedMessage `protobuf:"bytes,71,rep,name=map_string_nested_message,json=mapStringNestedMessage" json:"map_string_nested_message,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"bytes,2,opt,name=value"`
	MapStringNestedEnum    map[string]TestAllTypesProto3Editions_NestedEnum     `protobuf:"bytes,73,rep,name=map_string_nested_enum,json=mapStringNestedEnum" json:"map_string_nested_enum,omitempty" protobuf_key:"bytes,1,opt,name=certs" protobuf_val:"varint,2,opt,name=value,enum=goproto.grpc.test.TestAllTypesProto3Editions_NestedEnum"`
...
type TestAllTypesProto3Editions_OneofEnum struct {
	OneofEnum TestAllTypesProto3Editions_NestedEnum `protobuf:"varint,119,opt,name=oneof_enum,json=oneofEnum,enum=goproto.grpc.test.TestAllTypesProto3Editions_NestedEnum,oneof"`
}
...
var file_internal_testprotos_editionsfuzztest_test3editions_proto_goTypes = []any{
	(ForeignEnumProto3Editions)(0),                   // 0: goproto.grpc.test.ForeignEnumProto3Editions
	(TestAllTypesProto3Editions_NestedEnum)(0),       // 1: goproto.grpc.test.TestAllTypesProto3Editions.NestedEnum
	(*TestAllTypesProto3Editions)(nil),               // 2: goproto.grpc.test.TestAllTypesProto3Editions
	(*ForeignMessageProto3Editions)(nil),             // 3: goproto.grpc.test.ForeignMessageProto3Editions
	(*TestAllTypesProto3Editions_NestedMessage)(nil), // 4: goproto.grpc.test.TestAllTypesProto3Editions.NestedMessage
	nil, // 5: goproto.grpc.test.TestAllTypesProto3Editions.MapInt32Int32Entry
	nil, // 6: goproto.grpc.test.TestAllTypesProto3Editions.MapInt64Int64Entry
	nil, // 7: goproto.grpc.test.TestAllTypesProto3Editions.MapUint32Uint32Entry
	nil, // 8: goproto.grpc.test.TestAllTypesProto3Editions.MapUint64Uint64Entry
	nil, // 9: goproto.grpc.test.TestAllTypesProto3Editions.MapSint32Sint32Entry
	nil, // 10: goproto.grpc.test.TestAllTypesProto3Editions.MapSint64Sint64Entry
	nil, // 11: goproto.grpc.test.TestAllTypesProto3Editions.MapFixed32Fixed32Entry
	nil, // 12: goproto.grpc.test.TestAllTypesProto3Editions.MapFixed64Fixed64Entry
	nil, // 13: goproto.grpc.test.TestAllTypesProto3Editions.MapSfixed32Sfixed32Entry
	nil, // 14: goproto.grpc.test.TestAllTypesProto3Editions.MapSfixed64Sfixed64Entry
	nil, // 15: goproto.grpc.test.TestAllTypesProto3Editions.MapInt32FloatEntry
	nil, // 16: goproto.grpc.test.TestAllTypesProto3Editions.MapInt32DoubleEntry
	nil, // 17: goproto.grpc.test.TestAllTypesProto3Editions.MapBoolBoolEntry
	nil, // 18: goproto.grpc.test.TestAllTypesProto3Editions.MapStringStringEntry
	nil, // 19: goproto.grpc.test.TestAllTypesProto3Editions.MapStringBytesEntry
	nil, // 20: goproto.grpc.test.TestAllTypesProto3Editions.MapStringNestedMessageEntry
	nil, // 21: goproto.grpc.test.TestAllTypesProto3Editions.MapStringNestedEnumEntry
}
var file_internal_testprotos_editionsfuzztest_test3editions_proto_depIdxs = []int32{
	4,  // 0: goproto.grpc.test.TestAllTypesProto3Editions.singular_nested_message:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.NestedMessage
	3,  // 1: goproto.grpc.test.TestAllTypesProto3Editions.singular_foreign_message:type_name -> goproto.grpc.test.ForeignMessageProto3Editions
	1,  // 2: goproto.grpc.test.TestAllTypesProto3Editions.singular_nested_enum:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.NestedEnum
	0,  // 3: goproto.grpc.test.TestAllTypesProto3Editions.singular_foreign_enum:type_name -> goproto.grpc.test.ForeignEnumProto3Editions
	4,  // 4: goproto.grpc.test.TestAllTypesProto3Editions.optional_nested_message:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.NestedMessage
	3,  // 5: goproto.grpc.test.TestAllTypesProto3Editions.optional_foreign_message:type_name -> goproto.grpc.test.ForeignMessageProto3Editions
	1,  // 6: goproto.grpc.test.TestAllTypesProto3Editions.optional_nested_enum:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.NestedEnum
	0,  // 7: goproto.grpc.test.TestAllTypesProto3Editions.optional_foreign_enum:type_name -> goproto.grpc.test.ForeignEnumProto3Editions
	4,  // 8: goproto.grpc.test.TestAllTypesProto3Editions.repeated_nested_message:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.NestedMessage
	3,  // 9: goproto.grpc.test.TestAllTypesProto3Editions.repeated_foreign_message:type_name -> goproto.grpc.test.ForeignMessageProto3Editions
	1,  // 10: goproto.grpc.test.TestAllTypesProto3Editions.repeated_nested_enum:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.NestedEnum
	0,  // 11: goproto.grpc.test.TestAllTypesProto3Editions.repeated_foreign_enum:type_name -> goproto.grpc.test.ForeignEnumProto3Editions
	5,  // 12: goproto.grpc.test.TestAllTypesProto3Editions.map_int32_int32:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.MapInt32Int32Entry
	6,  // 13: goproto.grpc.test.TestAllTypesProto3Editions.map_int64_int64:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.MapInt64Int64Entry
	7,  // 14: goproto.grpc.test.TestAllTypesProto3Editions.map_uint32_uint32:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.MapUint32Uint32Entry
	8,  // 15: goproto.grpc.test.TestAllTypesProto3Editions.map_uint64_uint64:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.MapUint64Uint64Entry
	9,  // 16: goproto.grpc.test.TestAllTypesProto3Editions.map_sint32_sint32:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.MapSint32Sint32Entry
	10, // 17: goproto.grpc.test.TestAllTypesProto3Editions.map_sint64_sint64:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.MapSint64Sint64Entry
	11, // 18: goproto.grpc.test.TestAllTypesProto3Editions.map_fixed32_fixed32:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.MapFixed32Fixed32Entry
	12, // 19: goproto.grpc.test.TestAllTypesProto3Editions.map_fixed64_fixed64:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.MapFixed64Fixed64Entry
	13, // 20: goproto.grpc.test.TestAllTypesProto3Editions.map_sfixed32_sfixed32:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.MapSfixed32Sfixed32Entry
	14, // 21: goproto.grpc.test.TestAllTypesProto3Editions.map_sfixed64_sfixed64:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.MapSfixed64Sfixed64Entry
	15, // 22: goproto.grpc.test.TestAllTypesProto3Editions.map_int32_float:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.MapInt32FloatEntry
	16, // 23: goproto.grpc.test.TestAllTypesProto3Editions.map_int32_double:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.MapInt32DoubleEntry
	17, // 24: goproto.grpc.test.TestAllTypesProto3Editions.map_bool_bool:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.MapBoolBoolEntry
	18, // 25: goproto.grpc.test.TestAllTypesProto3Editions.map_string_string:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.MapStringStringEntry
	19, // 26: goproto.grpc.test.TestAllTypesProto3Editions.map_string_bytes:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.MapStringBytesEntry
	20, // 27: goproto.grpc.test.TestAllTypesProto3Editions.map_string_nested_message:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.MapStringNestedMessageEntry
	21, // 28: goproto.grpc.test.TestAllTypesProto3Editions.map_string_nested_enum:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.MapStringNestedEnumEntry
	4,  // 29: goproto.grpc.test.TestAllTypesProto3Editions.oneof_nested_message:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.NestedMessage
	1,  // 30: goproto.grpc.test.TestAllTypesProto3Editions.oneof_enum:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.NestedEnum
	2,  // 31: goproto.grpc.test.TestAllTypesProto3Editions.NestedMessage.corecursive:type_name -> goproto.grpc.test.TestAllTypesProto3Editions
	4,  // 32: goproto.grpc.test.TestAllTypesProto3Editions.MapStringNestedMessageEntry.value:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.NestedMessage
	1,  // 33: goproto.grpc.test.TestAllTypesProto3Editions.MapStringNestedEnumEntry.value:type_name -> goproto.grpc.test.TestAllTypesProto3Editions.NestedEnum
